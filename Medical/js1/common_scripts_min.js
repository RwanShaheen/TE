...
! function(t, e) {
    ...
    "use strict";
    let t = "transitionend",
        e = t => null == t ? `${t}` : Object.prototype.toString.call(t).match(/\s([a-z]+)/i)[1].toLowerCase(),
        i = t => {
        ...
        h = t => l(t) ? t.jquery ? t[0] : t : "string" == typeof t && t.length > 0 ? document.querySelector(t) : null,
        c = t => {
            ...
            y = d ? (r = t, a = i, l = u, function t(e) {
                ...
                for (let {
                    ...
                    for (let n of i)
                        if (n === s) return F(e, {
                            delegateTarget: s
                        }), t.oneOff && W.off(r, e.type, a, l), l.apply(s, [e])
            }) : (h = t, c = u, function t(e) {
                return F(e, {
                    delegateTarget: h
                }), t.oneOff && W.off(h, e.type, c), c.apply(h, [e])
            });
        y.delegationSelector = d ? i : null, y.callable = u, y.oneOff = n, y.uidEvent = v, m[v] = y, t.addEventListener(p, y, d)
    }
    ...
    let W = {
        ...
        off(t, e, i, s) {
            if ("string" != typeof e || !t) return;
            let [n, o, r] = O(e, i, s), a = r !== e, l = P(t), h = l[r] || {}, c = e.startsWith(".");
            if (void 0 !== o) {
            ...
            if (c)
                for (let d of Object.keys(l)) L(t, l, d, e.slice(1));
        ...
        trigger(t, e, i) {
            ...
            let s = m(),
                ...
                a = !0,
                l = !1;
            e !== n && s && (o = s.Event(e, i), s(t).trigger(o), r = !o.isPropagationStopped(), a = !o.isImmediatePropagationStopped(), l = o.isDefaultPrevented());
            let h = new Event(e, {
                bubbles: r,
                cancelable: !0
            });
            return h = F(h, i), l && h.preventDefault(), a && t.dispatchEvent(h), h.defaultPrevented && o && o.preventDefault(), h
        }
    };
    ...
    let B = {
        ...
        getDataAttributes(t) {
            ...
            for (let s of i) {
                let n = s.replace(/^bs/, "");
                e[n = n.charAt(0).toLowerCase() + n.slice(1, n.length)] = R(t.dataset[s])
            }
            return e
        },
        ...
        _typeCheckConfig(t, i = this.constructor.DefaultType) {
            for (let s of Object.keys(i)) {
                let n = i[s],
                    o = t[s],
                    r = l(o) ? "element" : e(o);
                if (!RegExp(n).test(r)) throw TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${s}" provided type "${r}" but expected type "${n}".`)
            }
        }
    }
    class V extends U {
        ...
        dispose() {
            for (let t of (N.remove(this._element, this.constructor.DATA_KEY), W.off(this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames(this))) this[t] = null
        }
    ...
    class tc extends U {
        ...
        _initEvents() {
            this._supportPointerEvents ? (W.on(this._element, tr, t => this._start(t)), W.on(this._element, ta, t => this._end(t)), this._element.classList.add("pointer-event")) : (W.on(this._element, ts, t => this._start(t)), W.on(this._element, tn, t => this._move(t)), W.on(this._element, to, t => this._end(t)))
        }
    ...
    class tP extends V {
        ...
        _addEventListeners() {
            this._config.keyboard && W.on(this._element, ty, t => this._keydown(t)), "hover" === this._config.pause && (W.on(this._element, t$, () => this.pause()), W.on(this._element, tb, () => this._maybeEnableCycle())), this._config.touch && tc.isSupported() && this._addTouchEventListeners()
        }
        _addTouchEventListeners() {
            for (let t of te.find(".carousel-item img", this._element)) W.on(t, tw, t => t.preventDefault());
            let e = () => {
        ...
        _slide(t, e = null) {
            ...
            let d = () => {
                n.classList.remove(h, c), n.classList.add(tC), i.classList.remove(tC, c, h), this._isSliding = !1, r(tv)
            };
    ...
    class tB extends V {
        ...
        show() {
            ...
            let t = [];
            if (this._config.parent && (t = this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(t => t !== this._element).map(t => tB.getOrCreateInstance(t, {
                    toggle: !1
            ...
            this._element.classList.remove(tW), this._element.classList.add(tF), this._element.style[s] = 0, this._addAriaAndCollapsedClass(this._triggerArray, !0), this._isTransitioning = !0;
            let n = () => {
                    this._isTransitioning = !1, this._element.classList.remove(tF), this._element.classList.add(tW, tH), this._element.style[s] = "", W.trigger(this._element, tY)
                },
        ...
        hide() {
            ...
            for (let i of (this._element.style[e] = `${this._element.getBoundingClientRect()[e]}px`, f(this._element), this._element.classList.add(tF), this._element.classList.remove(tW, tH), this._triggerArray)) {
                let s = o(i);
                s && !this._isShown(s) && this._addAriaAndCollapsedClass([i], !1)
            }
            this._isTransitioning = !0;
            let n = () => {
                this._isTransitioning = !1, this._element.classList.remove(tF), this._element.classList.add(tW), W.trigger(this._element, tL)
            };
    ...
    W.on(document, t0, tN, function(t) {
        ...
        let e = n(this),
            i = te.find(e);
        for (let s of i) tB.getOrCreateInstance(s, {
            toggle: !1
        }).toggle()
    }), $(tB);
    var t1 = "bottom",
    ...
    let ed = {
        ...
        fn: function t(e) {
            ...
            Object.keys(i.elements).forEach(function(t) {
                var e = i.styles[t] || {},
                    s = i.attributes[t] || {},
                    n = i.elements[t];
                eh(n) && er(n) && (Object.assign(n.style, e), Object.keys(s).forEach(function(t) {
                    var e = s[t];
        ...
        effect: function t(e) {
            ...
            return Object.assign(i.elements.popper.style, s.popper), i.styles = s, i.elements.arrow && Object.assign(i.elements.arrow.style, s.arrow),
                function() {
                    Object.keys(i.elements).forEach(function(t) {
                        var e = i.elements[t],
                            n = i.attributes[t] || {},
                            o = Object.keys(i.styles.hasOwnProperty(t) ? i.styles[t] : s[t]).reduce(function(t, e) {
                                return t[e] = "", t
                            }, {});
                        eh(e) && er(e) && (Object.assign(e.style, o), Object.keys(n).forEach(function(t) {
                            e.removeAttribute(t)
                        }))
                    })
                }
    ...
    function ev(t, e, i) {
        ...
        var s = t.getBoundingClientRect(),
            n = 1,
            o = 1;
        e && eh(t) && (n = t.offsetWidth > 0 && em(s.width) / t.offsetWidth || 1, o = t.offsetHeight > 0 && em(s.height) / t.offsetHeight || 1);
    ...
    function ek(t) {
        return "html" === er(t) ? t : t.assignedSlot || t.parentNode || (ec(t) ? t.host : null) || ex(t)
    }
    ...
    function eC(t) {
        for (var e = ea(t), i = e_(t); i && ew(i) && "static" === eb(i).position;) i = e_(i);
        return i && ("html" === er(i) || "body" === er(i) && "static" === eb(i).position) ? e : i || function t(e) {
            var i = /firefox/i.test(eg());
            if (/Trident/i.test(eg()) && eh(e) && "fixed" === eb(e).position) return null;
            var s = ek(e);
            for (ec(s) && (s = s.host); eh(s) && 0 > ["html", "body"].indexOf(er(s));) {
                var n = eb(s);
                if ("none" !== n.transform || "none" !== n.perspective || "paint" === n.contain || -1 !== ["transform", "perspective"].indexOf(n.willChange) || i && "filter" === n.willChange || i && n.filter && "none" !== n.filter) return s;
                s = s.parentNode
            }
            return null
        }(t) || e
    ...
    let eE = {
        ...
        fn: function t(e) {
            ...
            if (r && a) {
                var d, u, p = (d = o.padding, u = s, e9("number" != typeof(d = "function" == typeof d ? d(Object.assign({}, u.rects, {
                        placement: u.placement
                    })) : d) ? d : eM(d, t4))),
                    f = ey(r),
                    m = s.rects.reference[c] + s.rects.reference[h] - a[h] - s.rects.popper[c],
        ...
        effect: function t(e) {
            ...
            null != n && ("string" != typeof n || (n = i.elements.popper.querySelector(n))) && e$(i.elements.popper, n) && (i.elements.arrow = n)
        },
    ...
    function eO(t) {
        ...
        if (c) {
            var k = eC(s),
                _ = "clientHeight",
                C = "clientWidth";
            k === ea(s) && (k = ex(s), "static" !== eb(k).position && "absolute" === l && (_ = "scrollHeight", C = "scrollWidth")), ("top" === o || (o === tV || o === tU) && "end" === r) && (w = t1, g -= (u && k === x && x.visualViewport ? x.visualViewport.height : k[_]) - n.height, g *= h ? 1 : -1), (o === tV || ("top" === o || o === t1) && "end" === r) && (b = tU, f -= (u && k === x && x.visualViewport ? x.visualViewport.width : k[C]) - n.width, f *= h ? 1 : -1)
        }
        var D, S, T, M, E = Object.assign({
                position: l
            }, c && eA),
            P = !0 === d ? (S = (D = {
                x: f,
        ...
        return (f = P.x, g = P.y, h) ? Object.assign({}, E, ((i = {})[w] = $ ? "0" : "", i[b] = y ? "0" : "", i.transform = 1 >= (x.devicePixelRatio || 1) ? "translate(" + f + "px, " + g + "px)" : "translate3d(" + f + "px, " + g + "px, 0)", i)) : Object.assign({}, E, ((e = {})[w] = $ ? g + "px" : "", e[b] = y ? f + "px" : "", e.transform = "", e))
    }
    let eY = {
        name: "computeStyles",
        enabled: !0,
        ...
        fn: function t(e) {
            ...
            null != i.modifiersData.popperOffsets && (i.styles.popper = Object.assign({}, i.styles.popper, eO(Object.assign({}, l, {
                offsets: i.modifiersData.popperOffsets,
                position: i.options.strategy,
                adaptive: void 0 === o || o,
                roundOffsets: a
            })))), null != i.modifiersData.arrow && (i.styles.arrow = Object.assign({}, i.styles.arrow, eO(Object.assign({}, l, {
    ...
    function ej(t, e) {
        ...
        var i, s = function t(e) {
                return ["html", "body", "#document"].indexOf(er(e)) >= 0 ? e.ownerDocument.body : eh(e) && eR(e) ? e : t(ek(e))
            }(t),
    ...
    function e1(t, e, i) {
        ...
        return e === tG ? eB(function t(e, i) {
            ...
            if (o) {
                ...
                var c = e8();
                (c || !c && "fixed" === i) && (l = o.offsetLeft, h = o.offsetTop)
            }
            return {
                width: r,
                height: a,
        ...
        }(t, i)) : el(e) ? (s = e, (o = ev(s, !1, "fixed" === (n = i))).top = o.top + s.clientTop, o.left = o.left + s.clientLeft, o.bottom = o.top + s.clientHeight, o.right = o.left + s.clientWidth, o.width = s.clientWidth, o.height = s.clientHeight, o.x = o.left, o.y = o.top, o) : eB((r = ex(t), l = ex(r), h = ez(r), c = null == (a = r.ownerDocument) ? void 0 : a.body, d = ep(l.scrollWidth, l.clientWidth, c ? c.scrollWidth : 0, c ? c.clientWidth : 0), u = ep(l.scrollHeight, l.clientHeight, c ? c.scrollHeight : 0, c ? c.clientHeight : 0), p = -h.scrollLeft + eN(r), f = -h.scrollTop, "rtl" === eb(c || l).direction && (p += ep(l.clientWidth, c ? c.clientWidth : 0) - d), {
            width: d,
            height: u,
            x: p,
            y: f
    ...
    function eV(t, e) {
        ...
        var i, s, n, o, r, a, l, h, c, d, u = e,
            ...
            S = (i = el(D) ? D : D.contextElement || ex(t.elements.popper), s = void 0 === v ? t3 : v, n = void 0 === y ? tG : y, o = g, c = (h = [].concat("clippingParents" === s ? (r = i, a = ej(ek(r)), l = ["absolute", "fixed"].indexOf(eb(r).position) >= 0 && eh(r) ? eC(r) : r, el(l) ? a.filter(function(t) {
                return el(t) && e$(t, l) && "body" !== er(t)
            }) : []) : [].concat(s), [n]))[0], (d = h.reduce(function(t, e) {
                var s = e1(i, e, o);
                return t.top = ep(s.top, t.top), t.right = ef(s.right, t.right), t.bottom = ef(s.bottom, t.bottom), t.left = ep(s.left, t.left), t
            }, e1(i, c, o))).width = d.right - d.left, d.height = d.bottom - d.top, d.x = d.left, d.y = d.top, d),
    ...
    let e2 = {
        ...
        fn: function t(e) {
            ...
            if (!i.modifiersData[n]._skip) {
                for (var o = s.mainAxis, r = void 0 === o || o, a = s.altAxis, l = void 0 === a || a, h = s.fallbackPlacements, c = s.padding, d = s.boundary, u = s.rootBoundary, p = s.altBoundary, f = s.flipVariations, m = void 0 === f || f, g = s.allowedAutoPlacements, v = i.options.placement, y = eu(v), $ = [v].concat(h || (y !== v && m ? function t(e) {
                        if (eu(e) === t2) return [];
                        var i = eH(e);
                        return [eF(e), i, eF(i)]
                    }(v) : [eH(v)])).reduce(function(t, e) {
                        var s, n, o, r, a, l, h, p, f, v, y, $, b, w;
                        return t.concat(eu(e) === t2 ? (s = i, n = {
                            placement: e,
                            boundary: d,
                            rootBoundary: u,
                            padding: c,
                        ...
                        }, r = (o = n).placement, a = o.boundary, l = o.rootBoundary, h = o.padding, p = o.flipVariations, v = void 0 === (f = o.allowedAutoPlacements) ? tK : f, 0 === (b = ($ = (y = eP(r)) ? p ? tZ : tZ.filter(function(t) {
                            return eP(t) === y
                        }) : t4).filter(function(t) {
                            return v.indexOf(t) >= 0
                        })).length && (b = $), Object.keys(w = b.reduce(function(t, e) {
                            return t[e] = eV(s, {
                                placement: e,
                                boundary: a,
                                rootBoundary: l,
                    ...
                    }, []), b = i.rects.reference, w = i.rects.popper, x = new Map, k = !0, _ = $[0], C = 0; C < $.length; C++) {
                    var D = $[C],
                        S = eu(D),
                        T = eP(D) === tq,
                    ...
                    var O = eH(A),
                        Y = [];
                    if (r && Y.push(P[S] <= 0), l && Y.push(P[A] <= 0, P[O] <= 0), Y.every(function(t) {
                            return t
                        })) {
                        _ = D, k = !1;
                        break
                ...
                if (k)
                    for (var I = m ? 3 : 1, L = function t(e) {
                ...
                i.placement !== _ && (i.modifiersData[n]._skip = !0, i.placement = _, i.reset = !0)
            }
        },
            ...
            fn: function t(e) {
                var i = e.state,
                    ...
                    a = tK.reduce(function(t, e) {
                        var s, n, o, a, l, h, c, d;
                        return t[e] = (s = e, n = i.rects, o = r, l = [tV, "top"].indexOf(a = eu(s)) >= 0 ? -1 : 1, c = (h = "function" == typeof o ? o(Object.assign({}, n, {
                            placement: s
                        })) : o)[0], d = h[1], c = c || 0, d = (d || 0) * l, [tV, tU].indexOf(a) >= 0 ? {
                            x: d,
                            y: c
                        } : {
                            x: c,
                    ...
                    h = l.x,
                    c = l.y;
                null != i.modifiersData.popperOffsets && (i.modifiersData.popperOffsets.x += h, i.modifiersData.popperOffsets.y += c), i.modifiersData[n] = a
            }
        },
        e7 = {
            name: "popperOffsets",
        ...
        e5 = {
            ...
            fn: function t(e) {
                var i, s = e.state,
                    ...
                    k = s.rects.reference,
                    _ = s.rects.popper,
                    C = "function" == typeof m ? m(Object.assign({}, s.rects, {
                    ...
                    S = s.modifiersData.offset ? s.modifiersData.offset[s.placement] : null,
                    T = {
                        x: 0,
                        y: 0
                    };
                if (x) {
                    if (void 0 === r || r) {
                        var M, E = "y" === b ? "top" : tV,
                            ...
                            N = s.modifiersData["arrow#persistent"] ? s.modifiersData["arrow#persistent"].padding : eT(),
                            R = N[E],
                            j = N[P],
                            B = eS(0, k[A], z[A]),
                            U = $ ? k[A] / 2 - L - B - R - D.mainAxis : H - B - R - D.mainAxis,
                            V = $ ? -k[A] / 2 + L + B + j + D.mainAxis : W + B + j + D.mainAxis,
                    ...
                    if (void 0 !== a && a) {
                        var X, Q, J, tt, te, ti = x[w],
                            ...
                            tc = p && tr ? (Q = tl, J = ti, tt = th, (te = eS(Q, J, tt)) > tt ? tt : te) : eS(p ? tl : tn, ti, p ? th : to);
                        x[w] = tc, T[w] = tc - ti
                    }
                    s.modifiersData[o] = T
                }
            ...
            var r, a, l = {
                ...
                d = {
                    ...
                    setOptions: function t(n) {
                        var r, a, c, p, f, m, g, v, y = "function" == typeof n ? n(l.options) : n;
                        u(), l.options = Object.assign({}, o, l.options, y), l.scrollParents = {
                            reference: el(e) ? ej(e) : e.contextElement ? ej(e.contextElement) : [],
                            popper: ej(i)
                        };
                        var $ = (v = (p = c = Object.keys(a = (r = [].concat(s, l.options.modifiers)).reduce(function(t, e) {
                            var i = t[e.name];
                            ...
                            return a[t]
                        }), f = new Map, m = new Set, g = [], p.forEach(function(t) {
                            f.set(t.name, t)
                        }), p.forEach(function(t) {
                            m.has(t.name) || function t(e) {
                        ...
                        }), g), eo.reduce(function(t, e) {
                            return t.concat(v.filter(function(t) {
                                return t.phase === e
                            }))
                        }, []));
                        return l.orderedModifiers = $.filter(function(t) {
                            return t.enabled
                    ...
                    forceUpdate: function t() {
                        if (!c) {
                            var e, i, s, n, o, r, a, h, u, p, f, m, g, v, y, $ = l.elements,
                                b = $.reference,
                                w = $.popper;
                            if (eK(b, w)) {
                                l.rects = {
                                    reference: (s = b, n = eC(w), o = "fixed" === l.options.strategy, r = eh(n), f = eh(n) && (u = em((h = (a = n).getBoundingClientRect()).width) / a.offsetWidth || 1, p = em(h.height) / a.offsetHeight || 1, 1 !== u || 1 !== p), m = ex(n), g = ev(s, f, o), v = {
                                        scrollLeft: 0,
                                        scrollTop: 0
                                    }, y = {
                                        x: 0,
                                        y: 0
                                    }, (r || !r && !o) && (("body" !== er(n) || eR(m)) && (v = (e = n, e !== ea(e) && eh(e) ? {
                                        scrollLeft: (i = e).scrollLeft,
                                        scrollTop: i.scrollTop
                                    } : ez(e))), eh(n) ? (y = ev(n, !0), y.x += n.clientLeft, y.y += n.clientTop) : m && (y.x = eN(m))), {
    ...
    var e6 = eX(),
        eQ = eX({
            defaultModifiers: [eL, e7, eY, ed]
        }),
        eJ = eX({
            defaultModifiers: [eL, e7, eY, ed, eG, e2, e5, eE, e3]
        });
    ...
    class iC extends V {
        constructor(t, e) {
            super(t, e), this._popper = null, this._parent = this._element.parentNode, this._menu = te.next(this._element, i8)[0] || te.prev(this._element, i8)[0] || te.findOne(i8, this._parent), this._inNavbar = this._detectNavbar()
        }
        static get Default() {
            return ik
        }
        ...
        show() {
            ...
            if (!e.defaultPrevented) {
                if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav"))
                    for (let i of [].concat(...document.body.children)) W.on(i, "mouseover", p);
                this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(ip), this._element.classList.add(ip), W.trigger(this._element, ih, t)
            }
        }
        hide() {
            if (d(this._element) || !this._isShown()) return;
        ...
        _completeHide(t) {
            ...
            if (!e.defaultPrevented) {
                if ("ontouchstart" in document.documentElement)
                    for (let i of [].concat(...document.body.children)) W.off(i, "mouseover", p);
                this._popper && this._popper.destroy(), this._menu.classList.remove(ip), this._element.classList.remove(ip), this._element.setAttribute("aria-expanded", "false"), B.removeDataAttribute(this._menu, "popper"), W.trigger(this._element, ia, t)
            }
        }
        _getConfig(t) {
        ...
        _createPopper() {
            ...
            let t = this._element;
            "parent" === this._config.reference ? t = this._parent : l(this._config.reference) ? t = h(this._config.reference) : "object" == typeof this._config.reference && (t = this._config.reference);
        ...
        _selectMenuItem({
            ...
            let i = te.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter(t => c(t));
        ...
        static clearMenus(t) {
            ...
            for (let i of e) {
                ...
                if (n.includes(s._element) || "inside" === s._config.autoClose && !o || "outside" === s._config.autoClose && o || s._menu.contains(t.target) && ("keyup" === t.type && "Tab" === t.key || /input|select|option|textarea|form/i.test(t.target.tagName))) continue;
                let r = {
        ...
        static dataApiKeydownHandler(t) {
            ...
            if (!s && !i || e && !i) return;
            t.preventDefault();
            let n = this.matches(im) ? this : te.prev(this, im)[0] || te.next(this, im)[0] || te.findOne(im, t.delegateTarget.parentNode),
    ...
    W.on(document, id, im, iC.dataApiKeydownHandler), W.on(document, id, i8, iC.dataApiKeydownHandler), W.on(document, ic, iC.clearMenus), W.on(document, iu, iC.clearMenus), W.on(document, ic, im, function(t) {
    ...
    class iM {
        ...
        hide() {
            let t = this.getWidth();
            this._disableOverFlow(), this._setElementAttributes(this._element, iT, e => e + t), this._setElementAttributes(iD, iT, e => e + t), this._setElementAttributes(iS, i9, e => e - t)
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, iT), this._resetElementAttributes(iD, iT), this._resetElementAttributes(iS, i9)
        }
        isOverflowing() {
    ...
    class iI extends U {
        ...
        show(t) {
            ...
            this._config.isAnimated && f(e), e.classList.add(iP), this._emulateAnimation(() => {
                b(t)
            })
        }
        hide(t) {
            ...
            this._getElement().classList.remove(iP), this._emulateAnimation(() => {
                this.dispose(), b(t)
            })
        }
        dispose() {
            this._isAppended && (W.off(this._element, iA), this._element.remove(), this._isAppended = !1)
        }
        _getElement() {
            if (!this._element) {
        ...
        _append() {
            ...
            this._config.rootElement.append(t), W.on(t, iA, () => {
    ...
    class iN extends U {
        ...
        activate() {
            !this._isActive && (this._config.autofocus && this._config.trapElement.focus(), W.off(document, iL), W.on(document, i0, t => this._handleFocusin(t)), W.on(document, iH, t => this._handleKeydown(t)), this._isActive = !0)
        }
        deactivate() {
        ...
        _handleFocusin(t) {
            ...
            0 === i.length ? e.focus() : this._lastTabNavDirection === iW ? i[i.length - 1].focus() : i[0].focus()
        }
        _handleKeydown(t) {
            "Tab" === t.key && (this._lastTabNavDirection = t.shiftKey ? iW : "forward")
        }
    }
    let iR = ".bs.modal",
        ij = `hide${iR}`,
    ...
    class i6 extends V {
        constructor(t, e) {
            super(t, e), this._dialog = te.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new iM, this._addEventListeners()
        }
        static get Default() {
            return iK
        }
        ...
        show(t) {
            ...
            let e = W.trigger(this._element, iU, {
                relatedTarget: t
            });
            !e.defaultPrevented && (this._isShown = !0, this._isTransitioning = !0, this._scrollBar.hide(), document.body.classList.add(i7), this._adjustDialog(), this._backdrop.show(() => this._showElement(t)))
        }
        hide() {
            if (!this._isShown || this._isTransitioning) return;
            let t = W.trigger(this._element, ij);
            !t.defaultPrevented && (this._isShown = !1, this._isTransitioning = !0, this._focustrap.deactivate(), this._element.classList.remove(i5), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated()))
        }
        dispose() {
        ...
        _showElement(t) {
            ...
            let i = () => {
                this._config.focus && this._focustrap.activate(), this._isTransitioning = !1, W.trigger(this._element, iV, {
                    relatedTarget: t
                })
            };
        ...
        _hideModal() {
            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(() => {
                document.body.classList.remove(i7), this._resetAdjustments(), this._scrollBar.reset(), W.trigger(this._element, i1)
            })
        }
        _isAnimated() {
        ...
        _triggerBackdropTransition() {
            ...
            !("hidden" === i || this._element.classList.contains(iZ)) && (e || (this._element.style.overflowY = "hidden"), this._element.classList.add(iZ), this._queueCallback(() => {
                this._element.classList.remove(iZ), this._queueCallback(() => {
    ...
    W.on(document, iG, '[data-bs-toggle="modal"]', function(t) {
        let e = o(this);
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), W.one(e, iU, t => {
            !t.defaultPrevented && W.one(e, i1, () => {
                c(this) && this.focus()
            })
        });
    ...
    class sm extends V {
        ...
        show(t) {
            ...
            let e = W.trigger(this._element, so, {
                relatedTarget: t
            });
            if (e.defaultPrevented) return;
            this._isShown = !0, this._backdrop.show(), this._config.scroll || new iM().hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(si);
            let i = () => {
                (!this._config.scroll || this._config.backdrop) && this._focustrap.activate(), this._element.classList.add(se), this._element.classList.remove(si), W.trigger(this._element, sr, {
                    relatedTarget: t
                })
            };
        ...
        hide() {
            ...
            let e = () => {
                this._element.classList.remove(se, ss), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || new iM().reset(), W.trigger(this._element, sh)
            };
    ...
    W.on(document, sd, '[data-bs-toggle="offcanvas"]', function(t) {
        ...
        for (let t of te.find("[aria-modal][class*=show][class*=offcanvas-]")) "fixed" !== getComputedStyle(t).position && sm.getOrCreateInstance(t).hide()
    }), q(sm), $(sm);
    let sg = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
        s8 = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
        sv = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i,
        sy = (t, e) => {
            let i = t.nodeName.toLowerCase();
            return e.includes(i) ? !sg.has(i) || Boolean(s8.test(t.nodeValue) || sv.test(t.nodeValue)) : e.filter(t => t instanceof RegExp).some(t => t.test(i))
        },
        s$ = {
    ...
    class sk extends U {
        ...
        _maybeSanitize(t) {
            return this._config.sanitize ? function t(e, i, s) {
    ...
    class sO extends V {
        ...
        dispose() {
            clearTimeout(this._timeout), W.off(this._element.closest(sS), sT, this._hideModalHandler), this.tip && this.tip.remove(), this._element.getAttribute("data-bs-original-title") && this._element.setAttribute("title", this._element.getAttribute("data-bs-original-title")), this._disposePopper(), super.dispose()
        }
        show() {
            ...
            if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(s), W.trigger(this._element, this.constructor.eventName("inserted"))), this._popper ? this._popper.update() : this._popper = this._createPopper(s), s.classList.add(sD), "ontouchstart" in document.documentElement)
                for (let o of [].concat(...document.body.children)) W.on(o, "mouseover", p);
            let r = () => {
                W.trigger(this._element, this.constructor.eventName("shown")), !1 === this._isHovered && this._leave(), this._isHovered = !1
            };
        ...
        hide() {
            ...
            if (e.classList.remove(sD), "ontouchstart" in document.documentElement)
                for (let i of [].concat(...document.body.children)) W.off(i, "mouseover", p);
            this._activeTrigger.click = !1, this._activeTrigger[sM] = !1, this._activeTrigger[s9] = !1, this._isHovered = null;
            let s = () => {
                !this._isWithActiveTrigger() && (this._isHovered || e.remove(), this._element.removeAttribute("aria-describedby"), W.trigger(this._element, this.constructor.eventName("hidden")), this._disposePopper())
            };
        ...
        _createTipElement(t) {
            ...
            if (!e) return null;
            e.classList.remove(sC, sD), e.classList.add(`bs-${this.constructor.NAME}-auto`);
            let s = i(this.constructor.NAME).toString();
            return e.setAttribute("id", s), this._isAnimated() && e.classList.add(sC), e
        }
        setContent(t) {
            this._newContent = t, this._isShown() && (this._disposePopper(), this.show())
        }
        _getTemplateFactory(t) {
            return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new sk({ ...this._config,
                content: t,
        ...
        _setListeners() {
            ...
            for (let e of t)
                if ("click" === e) W.on(this._element, this.constructor.eventName("click"), this._config.selector, t => {
                    let e = this._initializeOnDelegatedTarget(t);
                    e.toggle()
                });
                else if ("manual" !== e) {
                let i = e === s9 ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
                    s = e === s9 ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");
                W.on(this._element, i, this._config.selector, t => {
                    ...
                    let e = this._initializeOnDelegatedTarget(t);
                    e._activeTrigger["focusout" === t.type ? sM : s9] = e._element.contains(t.relatedTarget), e._leave()
                })
            }
    ...
    class sU extends V {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (W.off(this._config.target, sW), W.on(this._config.target, sW, sN, t => {
        ...
        _initializeTargetsAndObservables() {
            ...
            for (let e of t) {
                ...
                c(i) && (this._targetLinks.set(e.hash, e), this._observableSections.set(e.hash, i))
            }
        }
        _process(t) {
            this._activeTarget !== t && (this._clearActiveClass(this._config.target), this._activeTarget = t, t.classList.add(sz), this._activateParents(t), W.trigger(this._element, sH, {
                relatedTarget: t
            }))
        }
        _activateParents(t) {
            if (t.classList.contains("dropdown-item")) {
                te.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(sz);
                return
            }
    ...
    class nn extends V {
        constructor(t) {
            ...
            this._setInitialAttributes(this._parent, this._getChildren()), W.on(this._element, s7, t => this._keydown(t))
        }
        static get NAME() {
            return "tab"
        }
        ...
        _activate(t, e) {
            ...
            let i = () => {
                ...
                t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._toggleDropDown(t, !0), W.trigger(t, s3, {
                    relatedTarget: e
                })
            };
        ...
        _deactivate(t, e) {
            ...
            let i = () => {
                ...
                t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._toggleDropDown(t, !1), W.trigger(t, s4, {
                    relatedTarget: e
                })
            };
            this._queueCallback(i, t, t.classList.contains(s6))
        ...
        _keydown(t) {
            ...
            let e = [sZ, sK].includes(t.key),
                i = x(this._getChildren().filter(t => !d(t)), t.target, e, !0);
            i && (i.focus({
                preventScroll: !0
            }), nn.getOrCreateInstance(i).show())
        }
        _getChildren() {
        ...
        _toggleDropDown(t, e) {
            ...
            s(".dropdown-toggle", sX), s(".dropdown-menu", sQ), i.setAttribute("aria-expanded", e)
        }
    ...
    W.on(document, sG, ne, function(t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), !d(this) && nn.getOrCreateInstance(this).show()
    }), W.on(window, s5, () => {
    ...
    class ny extends V {
        ...
        show() {
            ...
            let e = () => {
                this._element.classList.remove(ng), W.trigger(this._element, np), this._maybeScheduleHide()
            };
            this._element.classList.remove(nf), f(this._element), this._element.classList.add(nm, ng), this._queueCallback(e, this._element, this._config.animation)
        }
        hide() {
            ...
            if (t.defaultPrevented) return;
            let e = () => {
                this._element.classList.add(nf), this._element.classList.remove(ng, nm), W.trigger(this._element, nd)
            };
            this._element.classList.add(ng), this._queueCallback(e, this._element, this._config.animation)
        }
        dispose() {
            this._clearTimeout(), this.isShown() && this._element.classList.remove(nm), super.dispose()
        }
        isShown() {
        ...
        _setListeners() {
            W.on(this._element, nr, t => this._onInteraction(t, !0)), W.on(this._element, na, t => this._onInteraction(t, !1)), W.on(this._element, nl, t => this._onInteraction(t, !0)), W.on(this._element, nh, t => this._onInteraction(t, !1))
        }
        _clearTimeout() {
...
function(t, e, i, s) {
    ...
    t.fn.parallax = function s(o) {
        return this.each(function() {
            var s = t(this),
                r = "object" == typeof o && o;
            this == e || this == i || s.is("body") ? n.configure(r) : s.data("px.parallax") ? "object" == typeof o && t.extend(s.data("px.parallax"), r) : (r = t.extend({}, s.data(), r), s.data("px.parallax", new n(this, r))), "string" == typeof o && ("destroy" == o ? n.destroy(this) : n[o]())
        })
...
function(t) {
    ...
    g.prototype = {
        ...
        open: function(i) {
            ...
            w("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? ($(h, function(t, e, i, s) {
            ...
            return e.isIE7 && (v += " mfp-ie7"), v && e._addClassToMFP(v), e.updateItemHTML(), w("BuildControls"), t("html").css(m), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || t(document.body)), e._lastFocusedEl = document.activeElement, setTimeout(function() {
                e.content ? (e._addClassToMFP(p), e._setFocus()) : e.bgOverlay.addClass(p), s.on("focusin" + u, e._onFocusIn)
        ...
        updateItemHTML: function() {
            ...
            var s = i.type;
            if (w("BeforeChange", [e.currItem ? e.currItem.type : "", s]), e.currItem = i, !e.currTemplate[s]) {
                var o = !!e.st[s] && e.st[s].markup;
                w("FirstMarkupParse", o), o ? e.currTemplate[s] = t(o) : e.currTemplate[s] = !0
            }
            n && n !== i.type && e.container.removeClass("mfp-" + n + "-holder");
            var r = e["get" + s.charAt(0).toUpperCase() + s.slice(1)](i, e.currTemplate[s]);
            e.appendContent(r, s), i.preloaded = !0, w(d, i), n = i.type, e.container.prepend(e.contentContainer), w("AfterChange")
        },
        ...
        parseEl: function(i) {
            ...
            return n.type = s || e.st.type || "inline", n.index = i, n.parsed = !0, e.items[i] = n, w("ElementParse", n), e.items[i]
        },
        ...
        updateStatus: function(t, s) {
            if (e.preloader) {
                ...
                w("UpdateStatus", n), t = n.status, s = n.text, e.preloader.html(s), e.preloader.find("a").on("click", function(t) {
        ...
        _checkIfClose: function(i) {
            if (!t(i).hasClass(m)) {
                ...
                if (s && n || !e.content || t(i).hasClass("mfp-close") || e.preloader && i === e.preloader[0]) return !0;
        ...
        _parseMarkup: function(e, i, s) {
            var n;
            s.data && (i = t.extend(s.data, i)), w(h, [e, i, s]), t.each(i, function(i, s) {
        ...
        if ("string" == typeof i) {
            if ("open" === i) {
                var n, o = v ? s.data("magnificPopup") : s[0].magnificPopup,
                    r = parseInt(arguments[1], 10) || 0;
                o.items ? n = o.items[r] : (n = s, o.delegate && (n = n.find(o.delegate)), n = n.eq(r)), e._openClick({
                    mfpEl: n
                }, s, o)
            } else e.isOpen && e[i].apply(e, Array.prototype.slice.call(arguments, 1))
        } else i = t.extend(!0, {}, i), v ? s.data("magnificPopup", i) : s[0].magnificPopup = i, e.addGroup(s, i);
        return s
    };
    var C, D, S, T = "inline",
        M = function() {
            ...
            getInline: function(i, s) {
                if (M(), i.src) {
                    ...
                    if (o.length) {
                        ...
                        r && r.tagName && (D || (D = b(C = n.hiddenClass), C = "mfp-" + C), S = o.after(D).detach().removeClass(C)), e.updateStatus("ready")
    ...
    t.magnificPopup.registerModule(P, {
        ...
        proto: {
            initAjax: function() {
                e.types.push(P), E = e.st.ajax.cursor, $(a + "." + P, O), $("BeforeChange." + P, O)
            },
            getAjax: function(i) {
                ...
                var s = t.extend({
                    ...
                    success: function(s, n, o) {
                        ...
                        w("ParseAjax", r), e.appendContent(t(r.data), P), i.finished = !0, A(), e._setFocus(), setTimeout(function() {
                            e.wrap.addClass(p)
    ...
    t.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var i = e.st.image,
                    s = ".image";
                e.types.push("image"), $(c + s, function() {
                    "image" === e.currItem.type && i.cursor && t(document.body).addClass(i.cursor)
                }), $(a + s, function() {
                    i.cursor && t(document.body).removeClass(i.cursor), y.off("resize" + u)
                }), $("Resize" + s, e.resizeImage), e.isLowIE && $("AfterChange", e.resizeImage)
            },
            ...
            _onImageHasSize: function(t) {
                t.img && (t.hasSize = !0, Y && clearInterval(Y), t.isCheckingImgSize = !1, w("ImageHasSize", t), t.imgHidden && (e.content && e.content.removeClass("mfp-loading"), t.imgHidden = !1))
            },
                ...
                var i = 0,
                    ...
                    n = function(o) {
                        Y && clearInterval(Y), Y = setInterval(function() {
                            ...
                            i > 200 && clearInterval(Y), 3 == ++i ? n(10) : 40 === i ? n(50) : 100 === i && n(500)
                        }, o)
                    };
                n(1)
            },
            getImage: function(i, s) {
                var n = 0,
                    o = function() {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, w("ImageLoadComplete")) : ++n < 200 ? setTimeout(o, 100) : r())
                    },
                    r = function() {
                ...
                }, i), e.resizeImage(), i.hasSize) ? (Y && clearInterval(Y), i.loadError ? (s.addClass("mfp-loading"), e.updateStatus("error", a.tError.replace("%url%", i.src))) : (s.removeClass("mfp-loading"), e.updateStatus("ready")), s) : (e.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, s.addClass("mfp-loading"), e.findImageSize(i)), s)
            }
        }
    ...
    t.magnificPopup.registerModule(H, {
        ...
        proto: {
            initIframe: function() {
                e.types.push(H), $("BeforeChange", function(t, e, i) {
                    e !== i && (e === H ? W() : i === H && W(!0))
                }), $(a + "." + H, function() {
                    W()
                })
        ...
        proto: {
            initGallery: function() {
                ...
                o += " mfp-gallery", $(c + n, function() {
                    ...
                    if (e.items.length > 1 && i.arrows && !e.arrowLeft) {
                        var s = i.arrowMarkup,
                            n = e.arrowLeft = t(s.replace(/%title%/gi, i.tPrev).replace(/%dir%/gi, "left")).addClass(m),
                            o = e.arrowRight = t(s.replace(/%title%/gi, i.tNext).replace(/%dir%/gi, "right")).addClass(m);
                        n.click(function() {
                            e.prev()
                        }), o.click(function() {
                            e.next()
            ...
            _preloadItem: function(i) {
                if (i = F(i), !e.items[i].preloaded) {
                    var s = e.items[i];
                    s.parsed || (s = e.parseEl(i)), w("LazyLoad", s), "image" === s.type && (s.img = t('<img class="mfp-img" />').on("load.mfploader", function() {
                        s.hasSize = !0
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var t = e.st.retina,
                        i = t.ratio;
                    (i = isNaN(i) ? i() : i) > 1 && ($("ImageHasSize." + N, function(t, e) {
                        e.img.css({
...
(function() {
    ...
    e = function() {
        ...
        return n.prototype.defaults = {
            ...
            if (this.stopped = !1, this.boxes = (function() {
                    var t, i, s, n;
                    for (t = 0, s = this.element.querySelectorAll("." + this.config.boxClass), n = [], i = s.length; t < i; t++) e = s[t], n.push(e);
                    return n
                }).call(this), this.all = (function() {
                    var t, i, s, n;
                    for (t = 0, s = this.boxes, n = [], i = s.length; t < i; t++) e = s[t], n.push(e);
                    return n
                }).call(this), this.boxes.length) {
                if (this.disabled()) this.resetStyle();
                else
                    for (i = 0, s = (n = this.boxes).length; i < s; i++) e = n[i], this.applyStyle(e, !0)
            }
            if (this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live) return new t((o = this, function(t) {
                var e, i, s, n, r;
                for (e = 0, r = [], i = t.length; e < i; e++) n = t[e], r.push((function() {
                    var t, e, i, o;
                    for (t = 0, i = n.addedNodes || [], o = [], e = i.length; t < e; t++) s = i[t], o.push(this.doSync(s));
                    return o
                }).call(o));
                return r
            ...
            if (null == t && (t = this.element), 1 === t.nodeType) {
                for (i = 0, n = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass), o = [], s = n.length; i < s; i++) e = n[i], 0 > r.call(this.all, e) ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(e, !0), o.push(this.scrolled = !0)) : o.push(void 0);
                return o
            }
            ...
            var t, e, i, s, n;
            for (e = 0, s = this.boxes, n = [], i = s.length; e < i; e++) t = s[e], n.push(t.style.visibility = "visible");
            return n
            ...
            for (i in s = [], e) n = e[i], t["" + i] = n, s.push((function() {
                var e, s, r, a;
                for (e = 0, r = this.vendors, a = [], s = r.length; e < s; e++) o = r[e], a.push(t["" + o + i.charAt(0).toUpperCase() + i.substr(1)] = n);
                return a
            }).call(this));
            return s
        }, n.prototype.vendorCSS = function(t, e) {
            var i, n, o, r, a, l;
            for (i = 0, r = (a = s(t)).getPropertyCSSValue(e), n = (o = this.vendors).length; i < n; i++) l = o[i], r = r || a.getPropertyCSSValue("-" + l + "-" + e);
            return r
            ...
            var e, i, s, n, o;
            return i = t.getAttribute("data-wow-offset") || this.config.offset, n = (o = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset) + Math.min(this.element.clientHeight, this.util().innerHeight()) - i, e = (s = this.offsetTop(t)) + t.clientHeight, s <= n && e >= o
    ...
    function(t) {
        ...
        "use strict";
        var o, r, a, l = 0,
            h = (r = s.userAgent, a = /msie\s\d+/i, r.search(a) > 0 && (o = (o = a.exec(r).toString()).split(" ")[1]) < 9 && (t("html").addClass("lt-ie9"), !0));
        Function.prototype.bind || (Function.prototype.bind = function t(e) {
            ...
            var n = s.call(arguments, 1),
                o = function() {
                    if (!(this instanceof o)) return i.apply(e, n.concat(s.call(arguments)));
                    var t = function() {};
        ...
        var c = function(s, o, r) {
            ...
            for (h in a = {
                ...
                }).values = l.values && l.values.split(","), l) l.hasOwnProperty(h) && (n === l[h] || "" === l[h]) && delete l[h];
            d !== n && "" !== d && ((d = d.split(l.input_values_separator || o.input_values_separator || ";"))[0] && d[0] == +d[0] && (d[0] = +d[0]), d[1] && d[1] == +d[1] && (d[1] = +d[1]), o && o.values && o.values.length ? (a.from = d[0] && o.values.indexOf(d[0]), a.to = d[1] && o.values.indexOf(d[1])) : (a.from = d[0] && +d[0], a.to = d[1] && +d[1])), t.extend(a, o), t.extend(a, l), this.options = a, this.update_check = {}, this.validate(), this.result = {
        ...
        c.prototype = {
                ...
                remove: function() {
                    this.$cache.cont.remove(), this.$cache.cont = null, this.$cache.line.off("keydown.irs_" + this.plugin_count), this.$cache.body.off("touchmove.irs_" + this.plugin_count), this.$cache.body.off("mousemove.irs_" + this.plugin_count), this.$cache.win.off("touchend.irs_" + this.plugin_count), this.$cache.win.off("mouseup.irs_" + this.plugin_count), h && (this.$cache.body.off("mouseup.irs_" + this.plugin_count), this.$cache.body.off("mouseleave.irs_" + this.plugin_count)), this.$cache.grid_labels = [], this.coords.big = [], this.coords.big_w = [], this.coords.big_p = [], this.coords.big_x = [], cancelAnimationFrame(this.raf_id)
                },
                bindEvents: function() {
                    !this.no_diapason && (this.$cache.body.on("touchmove.irs_" + this.plugin_count, this.pointerMove.bind(this)), this.$cache.body.on("mousemove.irs_" + this.plugin_count, this.pointerMove.bind(this)), this.$cache.win.on("touchend.irs_" + this.plugin_count, this.pointerUp.bind(this)), this.$cache.win.on("mouseup.irs_" + this.plugin_count, this.pointerUp.bind(this)), this.$cache.line.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(this, "click")), this.$cache.line.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(this, "click")), this.$cache.line.on("focus.irs_" + this.plugin_count, this.pointerFocus.bind(this)), this.options.drag_interval && "double" === this.options.type ? (this.$cache.bar.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(this, "both")), this.$cache.bar.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(this, "both"))) : (this.$cache.bar.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(this, "click")), this.$cache.bar.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(this, "click"))), "single" === this.options.type ? (this.$cache.single.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(this, "single")), this.$cache.s_single.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(this, "single")), this.$cache.shad_single.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(this, "click")), this.$cache.single.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(this, "single")), this.$cache.s_single.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(this, "single")), this.$cache.edge.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(this, "click")), this.$cache.shad_single.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(this, "click"))) : (this.$cache.single.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(this, null)), this.$cache.single.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(this, null)), this.$cache.from.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(this, "from")), this.$cache.s_from.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(this, "from")), this.$cache.to.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(this, "to")), this.$cache.s_to.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(this, "to")), this.$cache.shad_from.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(this, "click")), this.$cache.shad_to.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(this, "click")), this.$cache.from.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(this, "from")), this.$cache.s_from.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(this, "from")), this.$cache.to.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(this, "to")), this.$cache.s_to.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(this, "to")), this.$cache.shad_from.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(this, "click")), this.$cache.shad_to.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(this, "click"))), this.options.keyboard && this.$cache.line.on("keydown.irs_" + this.plugin_count, this.key.bind(this, "keyboard")), h && (this.$cache.body.on("mouseup.irs_" + this.plugin_count, this.pointerUp.bind(this)), this.$cache.body.on("mouseleave.irs_" + this.plugin_count, this.pointerUp.bind(this))))
                },
                pointerFocus: function(t) {
                    if (!this.target) {
                        var e, i;
                        e = (i = "single" === this.options.type ? this.$cache.single : this.$cache.from).offset().left, e += i.width() / 2 - 1, this.pointerClick("single", {
                ...
                pointerDown: function(e, i) {
                    ...
                    2 !== i.button && ("both" === e && this.setTempMinInterval(), e || (e = this.target || "from"), this.current_plugin = this.plugin_count, this.target = e, this.is_active = !0, this.dragging = !0, this.coords.x_gap = this.$cache.rs.offset().left, this.coords.x_pointer = s - this.coords.x_gap, this.calcPointerPercent(), this.changeLevel(e), h && t("*").prop("unselectable", !0), this.$cache.line.trigger("focus"), this.updateScene())
                },
                ...
                calc: function(t) {
                    if (this.options) {
                        if (this.calc_count++, (10 === this.calc_count || t) && (this.calc_count = 0, this.coords.w_rs = this.$cache.rs.outerWidth(!1), this.calcHandlePercent()), this.coords.w_rs) {
                ...
                drawLabels: function() {
                    if (this.options) {
                        ...
                        if (!this.options.hide_from_to) {
                            if ("single" === this.options.type) o ? (t = this.decorate(r[this.result.from]), this.$cache.single.html(t)) : (s = this._prettify(this.result.from), t = this.decorate(s, this.result.from), this.$cache.single.html(t)), this.calcLabels(), this.labels.p_single_left < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible";
                            else {
                                o ? (this.options.decorate_both ? (t = this.decorate(r[this.result.from]), t += this.options.values_separator, t += this.decorate(r[this.result.to])) : t = this.decorate(r[this.result.from] + this.options.values_separator + r[this.result.to]), e = this.decorate(r[this.result.from]), i = this.decorate(r[this.result.to]), this.$cache.single.html(t), this.$cache.from.html(e), this.$cache.to.html(i)) : (s = this._prettify(this.result.from), n = this._prettify(this.result.to), this.options.decorate_both ? (t = this.decorate(s, this.result.from), t += this.options.values_separator, t += this.decorate(n, this.result.to)) : t = this.decorate(s + this.options.values_separator + n, this.result.to), e = this.decorate(s, this.result.from), i = this.decorate(n, this.result.to), this.$cache.single.html(t), this.$cache.from.html(e), this.$cache.to.html(i)), this.calcLabels();
                ...
                convertToPercent: function(t, e) {
                    var i, s, n = this.options.max - this.options.min;
                    return n ? (s = (i = e ? t : t - this.options.min) / (n / 100), this.toFixed(s)) : (this.no_diapason = !0, 0)
                },
                convertToValue: function(t) {
                    ...
                    o && (a = e = o.length), r && (a = i = r.length), e && i && (a = e >= i ? e : i), s < 0 && (l = Math.abs(s), s = +(s + l).toFixed(a), n = +(n + l).toFixed(a));
                    var h, c = (n - s) / 100 * t + s,
                        d = this.options.step.toString().split(".")[1];
                    return d ? c = +c.toFixed(d.length) : (c /= this.options.step, c *= this.options.step, c = +c.toFixed(0)), l && (c -= l), (h = d ? +c.toFixed(d.length) : this.toFixed(c)) < this.options.min ? h = this.options.min : h > this.options.max && (h = this.options.max), h
                },
                ...
                checkEdges: function(t, e) {
                    return this.options.force_edges && (t < 0 ? t = 0 : t > 100 - e && (t = 100 - e)), this.toFixed(t)
                },
                validate: function() {
                    ...
                    if ("string" == typeof i.min && (i.min = +i.min), "string" == typeof i.max && (i.max = +i.max), "string" == typeof i.from && (i.from = +i.from), "string" == typeof i.to && (i.to = +i.to), "string" == typeof i.step && (i.step = +i.step), "string" == typeof i.from_min && (i.from_min = +i.from_min), "string" == typeof i.from_max && (i.from_max = +i.from_max), "string" == typeof i.to_min && (i.to_min = +i.to_min), "string" == typeof i.to_max && (i.to_max = +i.to_max), "string" == typeof i.grid_num && (i.grid_num = +i.grid_num), i.max < i.min && (i.max = i.min), o)
                        for (e = 0, i.p_values = [], i.min = 0, i.max = o - 1, i.step = 1, i.grid_num = i.max, i.grid_snap = !0; e < o; e++) isNaN(t = +n[e]) ? t = n[e] : (n[e] = t, t = this._prettify(t)), i.p_values.push(t);
                ...
                appendGrid: function() {
                    if (this.options.grid) {
                        ...
                        for (this.calcGridMargin(), o.grid_snap ? r > 50 ? (a = 50 / o.step, l = this.toFixed(o.step / .5)) : (a = r / o.step, l = this.toFixed(o.step / (r / 100))) : l = this.toFixed(100 / a), a > 4 && (c = 3), a > 7 && (c = 2), a > 14 && (c = 1), a > 28 && (c = 0), t = 0; t < a + 1; t++) {
                            for (i = c, (h = this.toFixed(l * t)) > 100 && (h = 100), this.coords.big[t] = h, s = (h - l * (t - 1)) / (i + 1), e = 1; e <= i && 0 !== h; e++) u += '<span class="irs-grid-pol small" style="left: ' + (d = this.toFixed(h - s * e)) + '%"></span>';
                            u += '<span class="irs-grid-pol" style="left: ' + h + '%"></span>', n = this.convertToValue(h), u += '<span class="irs-grid-text js-grid-text-' + t + '" style="left: ' + h + '%">' + (n = o.values.length ? o.p_values[n] : this._prettify(n)) + "</span>"
                        }
                ...
                calcGridCollision: function(t, e, i) {
                    ...
                    for (s = 0; s < r && !((n = s + t / 2) >= r); s += t) o = this.$cache.grid_labels[n][0], i[s] <= e[n] ? o.style.visibility = "visible" : o.style.visibility = "hidden"
                },
                calcGridMargin: function() {
                    if (this.options.grid_margin) this.coords.w_rs = this.$cache.rs.outerWidth(!1), this.coords.w_rs && ("single" === this.options.type ? this.coords.w_handle = this.$cache.s_single.outerWidth(!1) : this.coords.w_handle = this.$cache.s_from.outerWidth(!1), this.coords.p_handle = this.toFixed(this.coords.w_handle / this.coords.w_rs * 100), this.coords.grid_gap = this.toFixed(this.coords.p_handle / 2 - .1), this.$cache.grid[0].style.width = this.toFixed(100 - this.coords.p_handle) + "%", this.$cache.grid[0].style.left = this.coords.grid_gap + "%")
                },
                update: function(e) {
                ...
                return this.each(function() {
                    t.data(this, "ionRangeSlider") || t.data(this, "ionRangeSlider", new c(this, e, l++))
                })
            },
            function() {
    ...
    function(t) {
        t.fn.footerReveal = function(e) {
            ...
            return t.extend(!0, {}, o, e), i.outerHeight() <= n.outerHeight() && (i.css({
                "z-index": o.zIndex,
                position: "fixed",
                bottom: 0
            }), o.shadow && s.css({
    ...
    function(t) {
        ...
        function i(i, s, n) {
            ...
            n = t.extend(!0, {}, a, n), this.settings = t.extend(!0, {}, e, n), this._defaults = e, "-" === this.settings.content.target && (this.settings.content.target = this.settings.url_target), this.animations = {
                start: "webkitAnimationStart oanimationstart MSAnimationStart animationstart",
                end: "webkitAnimationEnd oanimationend MSAnimationEnd animationend"
            }, "number" == typeof this.settings.offset && (this.settings.offset = {
                x: this.settings.offset,
                y: this.settings.offset
            }), (this.settings.allow_duplicates || !this.settings.allow_duplicates && (o = this, r = !1, t('[data-notify="container"]').each(function(e, i) {
                var s = t(i),
                    n = s.find('[data-notify="title"]').html().trim(),
                    a = s.find('[data-notify="message"]').html().trim(),
                    l = n === t("<div>" + o.settings.content.title + "</div>").html().trim(),
                    h = a === t("<div>" + o.settings.content.message + "</div>").html().trim(),
        ...
        String.format = function() {
            ...
            return e.replace(/(\{\{\d\}\}|\{\d\})/g, function(e) {
                return "{{" === e.substring(0, 2) ? e : (0, t[parseInt(e.match(/\d/)[0]) + 1])
            })
                    ...
                    update: function(e, i) {
                        ...
                        for (var n in "string" == typeof e ? s[e] = i : s = e, s) switch (n) {
                            ...
                            case "icon":
                                ...
                                "class" === t.settings.icon_type.toLowerCase() ? o.removeClass(t.settings.content.icon).addClass(s[n]) : (o.is("img") || o.find("img"), o.attr("src", s[n])), t.settings.content.icon = s[e];
                                break;
                            case "progress":
                                var r = t.settings.delay - t.settings.delay * (s[n] / 100);
                                this.$ele.data("notify-delay", r), this.$ele.find('[data-notify="progressbar"] > div').attr("aria-valuenow", s[n]).css("width", s[n] + "%");
                                break;
                            case "url":
            ...
            placement: function() {
                ...
                this.$ele.css(s).addClass(this.settings.animate.enter), t.each(["webkit-", "moz-", "o-", "ms-", ""], function(t, i) {
    ...
    function(t, e, i, s) {
        ...
        n.Defaults = {
            ...
            var i = this.current(),
                ...
                a = this.minimum(),
                l = this.maximum();
            this.settings.loop ? (!this.settings.rewind && Math.abs(n) > r / 2 && (n += -1 * o * r), (s = (((t = i + n) - a) % r + r) % r + a) !== t && s - n <= l && s - n > 0 && (i = s - n, t = s, this.reset(i))) : this.settings.rewind ? (l += 1, t = (t % l + l) % l) : t = Math.max(a, Math.min(l, t)), this.speed(this.duration(i, t, e)), this.current(t), this.isVisible() && this.update()
    ...
    function(t, e, i, s) {
        ...
        n.Defaults = {
            ...
            var i, s, n = t(e.target).closest("." + this._core.settings.itemClass),
                o = this._videos[n.attr("data-video")],
                r = o.width || "100%",
                a = o.height || this._core.$stage.height();
            !this._playing && (this._core.enter("playing"), this._core.trigger("play", null, "video"), n = this._core.items(this._core.relative(n.index())), this._core.reset(n.index()), (i = t('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", a), i.attr("width", r), "youtube" === o.type ? i.attr("src", "//www.youtube.com/embed/" + o.id + "?autoplay=1&rel=0&v=" + o.id) : "vimeo" === o.type ? i.attr("src", "//player.vimeo.com/video/" + o.id + "?autoplay=1") : "vzaar" === o.type && i.attr("src", "//view.vzaar.com/" + o.id + "/player?autoplay=true"), s = t(i).wrap('<div class="owl-video-frame" />').insertAfter(n.find(".owl-video")), this._playing = n.addClass("owl-video-playing"))
    ...
    function(t) {
        ...
        o.prototype = {
            init: function(e) {
                this.update(e, n) && (this.element.addClass(this.options.className), this.options.innerToggle && (this.wrapElement(this.options.wrapper), this.initToggle(this.options.toggle), "string" == typeof this.options.innerToggle && (this.toggleElement.hide(), this.element.one(this.options.innerToggle, t.proxy(function() {
            ...
            prepareOptions: function(e, i) {
                ...
                if (i = i || this.options, e = t.extend(!0, {}, i, e), n.hasOwnProperty("wrapper") && n.wrapper.hasOwnProperty("inheritStyles") && (e.wrapper.inheritStyles = n.wrapper.inheritStyles), e.enable && ("toggle" === e.show ? e.show = this.isType("hidden", e.states) : "infer" === e.show && (e.show = this.isType("shown", e.states)), "infer" === e.toggle.position && (e.toggle.position = "rtl" === this.element.css("text-direction") ? "left" : "right"), !t.isArray(e.toggle.attachToKeyCodes))) {
                    if (!0 === e.toggle.attachToKeyCodes) switch ((s = t(e.toggle.element)).prop("tagName").toLowerCase()) {
                        case "button":
                        case "input":
                            break;
                        case "a":
            ...
            state: function(t, i, s) {
                return s = s || this.options.states, t === e && (t = this.options.show), "boolean" == typeof t && (t = t ? "shown" : "hidden"), i && (t = "shown" === t ? "hidden" : "shown"), s[t]
            },
            ...
            wrapElement: function(e) {
                ...
                }, this)), this.element.css(e.innerElementStyles).wrap(t(e.element).addClass(e.className).css(e.styles)), this.wrapperElement = this.element.parent(), !0 === s && (s = this.wrapperElement.outerWidth() !== i && i), !1 !== s && this.wrapperElement.css("width", s)), this.wrapperElement
            },
            ...
            toggleTouchEvent: function(t) {
                ...
                n && (e = t.pageX || t.originalEvent.pageX, "left" === this.options.toggle.position ? (n += this.toggleElement.outerWidth(), i = e, s = n) : (i = n, s = e), s >= i && this.toggleEvent(t))
            }
    ...
    function(t, e) {
        ...
        _ = Array.prototype.some ? Array.prototype.some : function(t) {
        ...
        function f(t, e) {
            var i, n, o;
            if (s(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), s(e._i) || (t._i = e._i), s(e._f) || (t._f = e._f), s(e._l) || (t._l = e._l), s(e._strict) || (t._strict = e._strict), s(e._tzm) || (t._tzm = e._tzm), s(e._isUTC) || (t._isUTC = e._isUTC), s(e._offset) || (t._offset = e._offset), s(e._pf) || (t._pf = c(e)), s(e._locale) || (t._locale = e._locale), 0 < p.length)
        ...
        function b(t, e, i) {
            var s, n = Math.min(t.length, e.length),
                ...
                r = 0;
            for (s = 0; s < n; s++)(i && t[s] !== e[s] || !i && $(t[s]) !== $(e[s])) && r++;
            return r + o
        }
        ...
        function S(e, i) {
            null != t.deprecationHandler && t.deprecationHandler(e, i), D[e] || (w(i), D[e] = !0)
        }
        ...
        function M(t, e) {
            var s, n = l({}, t);
            for (s in e) a(e, s) && (i(t[s]) && i(e[s]) ? (n[s] = {}, l(n[s], t[s]), l(n[s], e[s])) : null != e[s] ? n[s] = e[s] : delete n[s]);
        ...
        function j(t, e) {
            return t.isValid() ? (z[e = B(e, t.localeData())] = z[e] || function(t) {
                var e, i, s, n = t.match(W);
                for (e = 0, i = n.length; e < i; e++) N[n[e]] ? n[e] = N[n[e]] : n[e] = (s = n[e]).match(/\[[\s\S]/) ? s.replace(/^\[|\]$/g, "") : s.replace(/\\/g, "");
                return function(e) {
                    var s, o = "";
        ...
        function B(t, e) {
            ...
            for (F.lastIndex = 0; 0 <= i && F.test(t);) t = t.replace(F, s), F.lastIndex = 0, i -= 1;
            return t
        }
        var U = /\d/,
            V = /\d\d/,
        ...
        function tl(t, e, i) {
            ta[t] = T(e) ? e : function(t, s) {
                return t && i ? i : e
            }
        }

        function th(t, e) {
            return a(ta, t) ? ta[t](e._strict, e._locale) : RegExp(tc(t.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(t, e, i, s, n) {
                return e || i || s || n
            })))
        }
        ...
        function tu(t, e) {
            var i, s = e;
            for ("string" == typeof t && (t = [t]), n(e) && (s = function(t, i) {
                    i[e] = $(t)
                }), i = 0; i < t.length; i++) td[t[i]] = s
        }
        ...
        }), R(0, ["YYYY", 4], 0, "year"), R(0, ["YYYYY", 5], 0, "year"), R(0, ["YYYYYY", 6, !0], 0, "year"), A("year", "y"), I.year = 1, tl("Y", ts), tl("YY", K, V), tl("YYYY", tt, G), tl("YYYYY", te, Z), tl("YYYYYY", te, Z), tu(["YYYYY", "YYYYYY"], 0), tu("YYYY", function(e, i) {
        ...
        var tg, t8 = tv("FullYear", !0);

        function tv(e, i) {
            return function(s) {
                return null != s ? (t$(this, e, s), t.updateOffset(this, i), this) : ty(this, e)
            }
        }
        ...
        function t$(t, e, i) {
            t.isValid() && !isNaN(i) && ("FullYear" === e && tm(t.year()) && 1 === t.month() && 29 === t.date() ? t._d["set" + (t._isUTC ? "UTC" : "") + e](i, t.month(), tb(i, t.month())) : t._d["set" + (t._isUTC ? "UTC" : "") + e](i))
        }

        function tb(t, e) {
            if (isNaN(t) || isNaN(e)) return NaN;
            var i, s = (e % (i = 12) + i) % i;
            return t += (e - s) / 12, 1 === s ? tm(t) ? 29 : 28 : 31 - s % 7 % 2
        }
        tg = Array.prototype.indexOf ? Array.prototype.indexOf : function(t) {
            var e;
        ...
        }), A("month", "M"), I.month = 8, tl("M", K), tl("MM", K, V), tl("MMM", function(t, e) {
        ...
        var tw = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
            tx = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
        ...
        function t_(t, e) {
            ...
            return i = Math.min(t.date(), tb(t.year(), e)), t._d["set" + (t._isUTC ? "UTC" : "") + "Month"](e, i), t
        }

        function tC(e) {
            return null != e ? (t_(this, e), t.updateOffset(this, !0), this) : ty(this, "Month")
        }
        var tD = tr,
            tS = tr;
        ...
        function tT() {
            ...
            var e, i, s = [],
                n = [],
                o = [];
            for (e = 0; e < 12; e++) i = h([2e3, e]), s.push(this.monthsShort(i, "")), n.push(this.months(i, "")), o.push(this.months(i, "")), o.push(this.monthsShort(i, ""));
            for (s.sort(t), n.sort(t), o.sort(t), e = 0; e < 12; e++) s[e] = tc(s[e]), n[e] = tc(n[e]);
            for (e = 0; e < 24; e++) o[e] = tc(o[e]);
            this._monthsRegex = RegExp("^(" + o.join("|") + ")", "i"), this._monthsShortRegex = this._monthsRegex, this._monthsStrictRegex = RegExp("^(" + n.join("|") + ")", "i"), this._monthsShortStrictRegex = RegExp("^(" + s.join("|") + ")", "i")
        }
        ...
        function tE(t, e, i, s, n) {
            var o, r, a = 1 + 7 * (e - 1) + (7 + i - s) % 7 + tM(t, s, n);
            return r = a <= 0 ? tf(o = t - 1) + a : a > tf(t) ? (o = t + 1, a - tf(t)) : (o = t, a), {
                year: o,
                dayOfYear: r
            }
        }
        ...
        function tP(t, e, i) {
            var s, n, o = tM(t.year(), e, i),
                r = Math.floor((t.dayOfYear() - o - 1) / 7) + 1;
            return r < 1 ? s = r + tA(n = t.year() - 1, e, i) : r > tA(t.year(), e, i) ? (s = r - tA(t.year(), e, i), n = t.year() + 1) : (n = t.year(), s = r), {
                week: s,
                year: n
            }
        }
        ...
        R("w", ["ww", 2], "wo", "week"), R("W", ["WW", 2], "Wo", "isoWeek"), A("week", "w"), A("isoWeek", "W"), I.week = 5, I.isoWeek = 5, tl("w", K), tl("ww", K, V), tl("W", K), tl("WW", K, V), tp(["w", "ww", "W", "WW"], function(t, e, i, s) {
            e[s.substr(0, 1)] = $(t)
        });
        ...
        }), R("e", 0, 0, "weekday"), R("E", 0, 0, "isoWeekday"), A("day", "d"), A("weekday", "e"), A("isoWeekday", "E"), I.day = 11, I.weekday = 11, I.isoWeekday = 11, tl("d", K), tl("e", K), tl("E", K), tl("dd", function(t, e) {
        ...
        function tF() {
            ...
            var e, i, s, n, o, r = [],
                ...
                l = [],
                c = [];
            for (e = 0; e < 7; e++) i = h([2e3, 1]).day(e), s = this.weekdaysMin(i, ""), n = this.weekdaysShort(i, ""), o = this.weekdays(i, ""), r.push(s), a.push(n), l.push(o), c.push(s), c.push(n), c.push(o);
            for (r.sort(t), a.sort(t), l.sort(t), c.sort(t), e = 0; e < 7; e++) a[e] = tc(a[e]), l[e] = tc(l[e]), c[e] = tc(c[e]);
            this._weekdaysRegex = RegExp("^(" + c.join("|") + ")", "i"), this._weekdaysShortRegex = this._weekdaysRegex, this._weekdaysMinRegex = this._weekdaysRegex, this._weekdaysStrictRegex = RegExp("^(" + l.join("|") + ")", "i"), this._weekdaysShortStrictRegex = RegExp("^(" + a.join("|") + ")", "i"), this._weekdaysMinStrictRegex = RegExp("^(" + r.join("|") + ")", "i")
        }
        ...
        R("H", ["HH", 2], 0, "hour"), R("h", ["hh", 2], 0, tz), R("k", ["kk", 2], 0, function() {
            return this.hours() || 24
        }), R("hmm", 0, 0, function() {
            return "" + tz.apply(this) + H(this.minutes(), 2)
        }), R("hmmss", 0, 0, function() {
            return "" + tz.apply(this) + H(this.minutes(), 2) + H(this.seconds(), 2)
        }), R("Hmm", 0, 0, function() {
            return "" + this.hours() + H(this.minutes(), 2)
        }), R("Hmmss", 0, 0, function() {
            return "" + this.hours() + H(this.minutes(), 2) + H(this.seconds(), 2)
        }), tN("a", !0), tN("A", !1), A("hour", "h"), I.hour = 13, tl("a", tR), tl("A", tR), tl("H", K), tl("h", K), tl("k", K), tl("HH", K, V), tl("hh", K, V), tl("kk", K, V), tl("hmm", X), tl("hmmss", Q), tl("Hmm", X), tl("Hmmss", Q), tu(["H", "HH"], 3), tu(["k", "kk"], function(t, e, i) {
            var s = $(t);
            e[3] = 24 === s ? 0 : s
            ...
            var s = t.length - 2;
            e[3] = $(t.substr(0, s)), e[4] = $(t.substr(s)), c(i).bigHour = !0
        }), tu("hmmss", function(t, e, i) {
            var s = t.length - 4,
                n = t.length - 2;
            e[3] = $(t.substr(0, s)), e[4] = $(t.substr(s, 2)), e[5] = $(t.substr(n)), c(i).bigHour = !0
        }), tu("Hmm", function(t, e, i) {
            var s = t.length - 2;
            ...
            var s = t.length - 4,
                n = t.length - 2;
            e[3] = $(t.substr(0, s)), e[4] = $(t.substr(s, 2)), e[5] = $(t.substr(n))
        });
        var tj, tB = tv("Hours", !0),
            t1 = {
                calendar: {
                    sameDay: "[Today at] LT",
        ...
        function t4(t) {
            var e = null;
            if (!tU[t] && "undefined" != typeof module && module && module.exports) try {
        ...
        function tq(t, e) {
            var i;
            return t && ((i = s(e) ? tG(t) : t3(t, e)) ? tj = i : "undefined" != typeof console && console.warn && console.warn("Locale " + t + " not found. Did you forget to load it?")), tj._abbr
        }

        function t3(t, e) {
            if (null === e) return delete tU[t], null;
            var i, s = t1;
            if (e.abbr = t, null != tU[t]) S("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), s = tU[t]._config;
            else if (null != e.parentLocale) {
                if (null != tU[e.parentLocale]) s = tU[e.parentLocale]._config;
                else {
                    if (null == (i = t4(e.parentLocale))) return tV[e.parentLocale] || (tV[e.parentLocale] = []), tV[e.parentLocale].push({
                        name: t,
                        config: e
                    }), null;
                    s = i._config
            ...
            return tU[t] = new E(M(s, e)), tV[t] && tV[t].forEach(function(t) {
                t3(t.name, t.config)
            }), tq(t), tU[t]
        }
        ...
        function tG(t) {
            var i;
            if (t && t._locale && t._locale._abbr && (t = t._locale._abbr), !t) return tj;
            if (!e(t)) {
                if (i = t4(t)) return i;
                t = [t]
            }
            return function(t) {
                for (var e, i, s, n, o = 0; o < t.length;) {
                    for (e = (n = t2(t[o]).split("-")).length, i = (i = t2(t[o + 1])) ? i.split("-") : null; 0 < e;) {
        ...
        function t7(t) {
            var e, i = t._a;
            return i && -2 === c(t).overflow && (e = i[1] < 0 || 11 < i[1] ? 1 : i[2] < 1 || i[2] > tb(i[0], i[1]) ? 2 : i[3] < 0 || 24 < i[3] || 24 === i[3] && (0 !== i[4] || 0 !== i[5] || 0 !== i[6]) ? 3 : i[4] < 0 || 59 < i[4] ? 4 : i[5] < 0 || 59 < i[5] ? 5 : i[6] < 0 || 999 < i[6] ? 6 : -1, c(t)._overflowDayOfYear && (e < 0 || 2 < e) && (e = 2), c(t)._overflowWeeks && -1 === e && (e = 7), c(t)._overflowWeekday && -1 === e && (e = 8), c(t).overflow = e), t
        }
        ...
        function tZ(e) {
            var i, s, n, o, r, a, l, h = [];
            if (!e._d) {
                for (i = e, s = new Date(t.now()), r = i._useUTC ? [s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate()] : [s.getFullYear(), s.getMonth(), s.getDate()], e._w && null == e._a[2] && null == e._a[1] && function(t) {
                        var e, i, s, n, o, r, a, l;
                        if (null != (e = t._w).GG || null != e.W || null != e.E) o = 1, r = 4, i = t5(e.GG, t._a[0], tP(el(), 1, 4).year), s = t5(e.W, 1), ((n = t5(e.E, 1)) < 1 || 7 < n) && (l = !0);
                        else {
                            o = t._locale._week.dow, r = t._locale._week.doy;
                            var h = tP(el(), o, r);
                            i = t5(e.gg, t._a[0], h.year), s = t5(e.w, h.week), null != e.d ? ((n = e.d) < 0 || 6 < n) && (l = !0) : null != e.e ? (n = e.e + o, (e.e < 0 || 6 < e.e) && (l = !0)) : n = o
                        }
                        s < 1 || s > tA(i, o, r) ? c(t)._overflowWeeks = !0 : null != l ? c(t)._overflowWeekday = !0 : (a = tE(i, s, n, o, r), t._a[0] = a.year, t._dayOfYear = a.dayOfYear)
                    }(e), null != e._dayOfYear && (l = t5(e._a[0], r[0]), (e._dayOfYear > tf(l) || 0 === e._dayOfYear) && (c(e)._overflowDayOfYear = !0), o = t9(l, 0, e._dayOfYear), e._a[1] = o.getUTCMonth(), e._a[2] = o.getUTCDate()), n = 0; n < 3 && null == e._a[n]; ++n) e._a[n] = h[n] = r[n];
                for (; n < 7; n++) e._a[n] = h[n] = null == e._a[n] ? 2 === n ? 1 : 0 : e._a[n];
                24 === e._a[3] && 0 === e._a[4] && 0 === e._a[5] && 0 === e._a[6] && (e._nextDay = !0, e._a[3] = 0), e._d = (e._useUTC ? t9 : function(t, e, i, s, n, o, r) {
                    var a;
                    return t < 100 && 0 <= t ? isFinite((a = new Date(t + 400, e, i, s, n, o, r)).getFullYear()) && a.setFullYear(t) : a = new Date(t, e, i, s, n, o, r), a
                }).apply(null, h), a = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[3] = 24), e._w && void 0 !== e._w.d && e._w.d !== a && (c(e).weekdayMismatch = !0)
            }
        }
        var tK = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
            tX = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
            t6 = /Z|[+-]\d\d(?::?\d\d)?/,
            tQ = [
        ...
        function en(t) {
            var e, i, s, n = ei.exec(t._i.replace(/\([^)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s\s*/, "").replace(/\s\s*$/, ""));
            if (n) {
                var o, r, a, l, h, d, u, p, f, m = (o = n[4], r = n[3], a = n[2], l = n[5], h = n[6], d = n[7], f = [(u = o, (p = parseInt(u, 10)) <= 49 ? 2e3 + p : p <= 999 ? 1900 + p : p), tk.indexOf(r), parseInt(a, 10), parseInt(l, 10), parseInt(h, 10)], d && f.push(parseInt(d, 10)), f);
                if (e = n[1], i = m, s = t, e && tI.indexOf(e) !== new Date(i[0], i[1], i[2]).getDay() && (c(s).weekdayMismatch = !0, s._isValid = !1, 1)) return;
                t._a = m, t._tzm = function(t, e, i) {
                    ...
                    var s = parseInt(i, 10),
                        n = s % 100;
                    return (s - n) / 100 * 60 + n
                }(n[8], n[9], n[10]), t._d = t9.apply(null, t._a), t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), c(t).rfc2822 = !0
            } else t._isValid = !1
        }
        ...
        function eo(e) {
            if (e._f !== t.ISO_8601) {
                if (e._f !== t.RFC_2822) {
                    e._a = [], c(e).empty = !0;
                    var i, s, n, o, r, l, h, d, u, p, f, m, g = "" + e._i,
                        v = g.length,
                        y = 0;
                    for (h = B(e._f, e._locale).match(W) || [], r = 0; r < h.length; r++) d = h[r], (l = (g.match(th(d, e)) || [])[0]) && (0 < (u = g.substr(0, g.indexOf(l))).length && c(e).unusedInput.push(u), g = g.slice(g.indexOf(l) + l.length), y += l.length), N[d] ? (l ? c(e).empty = !1 : c(e).unusedTokens.push(d), p = d, m = e, null != (f = l) && a(td, p) && td[p](f, m._a, m, p)) : e._strict && !l && c(e).unusedTokens.push(d);
        ...
        function er(a) {
            var h, p, m, y, $ = a._i,
                b = a._f;
            return a._locale = a._locale || tG(a._l), null === $ || void 0 === b && "" === $ ? u({
                nullInput: !0
            }) : ("string" == typeof $ && (a._i = $ = a._locale.preparse($)), v($) ? new g(t7($)) : (o($) ? a._d = $ : e(b) ? function(t) {
                var e, i, s, n, o;
                if (0 === t._f.length) return c(t).invalidFormat = !0, t._d = new Date(NaN);
                for (n = 0; n < t._f.length; n++) o = 0, e = f({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[n], eo(e), d(e) && (o += c(e).charsLeftOver, o += 10 * c(e).unusedTokens.length, c(e).score = o, (null == s || o < s) && (s = o, i = e));
                l(t, i || e)
            }(a) : b ? eo(a) : s(p = (h = a)._i) ? h._d = new Date(t.now()) : o(p) ? h._d = new Date(p.valueOf()) : "string" == typeof p ? (m = h, null === (y = et.exec(m._i)) ? (ee(m), !1 === m._isValid && (delete m._isValid, en(m), !1 === m._isValid && (delete m._isValid, t.createFromInputFallback(m)))) : m._d = new Date(+y[1])) : e(p) ? (h._a = r(p.slice(0), function(t) {
            ...
            }(h) : n(p) ? h._d = new Date(p) : t.createFromInputFallback(h), d(a) || (a._d = null), a))
        }

        function ea(t, s, n, o, r) {
            var a, l = {};
            return !0 !== n && !1 !== n || (o = n, n = void 0), (i(t) && function(t) {
                var e;
                if (Object.getOwnPropertyNames) return 0 === Object.getOwnPropertyNames(t).length;
                for (e in t)
                    if (t.hasOwnProperty(e)) return !1;
                return !0
            }(t) || e(t) && 0 === t.length) && (t = void 0), l._isAMomentObject = !0, l._useUTC = l._isUTC = r, l._l = n, l._i = t, l._f = s, l._strict = o, (a = new g(t7(er(l))))._nextDay && (a.add(1, "d"), a._nextDay = void 0), a
        }
        ...
        var eu = ["year", "quarter", "month", "week", "day", "hour", "minute", "second", "millisecond"];
        ...
        function ep(t) {
            ...
            this._isValid = function(t) {
                ...
                return !0
            }(e), this._milliseconds = +c + 1e3 * h + 6e4 * l + 1e3 * a * 3600, this._days = +r + 7 * o, this._months = +n + 3 * s + 12 * i, this._data = {}, this._locale = tG(), this._bubble()
        }
        ...
        eg("Z", ":"), eg("ZZ", ""), tl("Z", to), tl("ZZ", to), tu(["Z", "ZZ"], function(t, e, i) {
        ...
        function ey(e, i) {
            var s, n;
            return i._isUTC ? (s = i.clone(), n = (v(e) || o(e) ? e.valueOf() : el(e).valueOf()) - s.valueOf(), s._d.setTime(s._d.valueOf() + n), t.updateOffset(s, !1), s) : el(e).local()
        }
        ...
        var ew = /^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/,
            ex = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
        ...
        function ek(t, e) {
            ...
            return ef(t) ? c = {
                ...
                d: t._days,
                M: t._months
            } : n(t) ? (c = {}, e ? c[e] = t : c.milliseconds = t) : (d = ew.exec(t)) ? (i = "-" === d[1] ? -1 : 1, c = {
                y: 0,
                d: $(d[2]) * i,
                h: $(d[3]) * i,
                m: $(d[4]) * i,
                ...
                m: e_(d[7], i),
                s: e_(d[8], i)
            }) : null == c ? c = {} : "object" == typeof c && ("from" in c || "to" in c) && (o = (r = el(c.from), l = el(c.to), r.isValid() && l.isValid() ? (l = ey(l, r), r.isBefore(l) ? h = eC(r, l) : ((h = eC(l, r)).milliseconds = -h.milliseconds, h.months = -h.months), h) : {
                milliseconds: 0,
                months: 0
            }), (c = {}).ms = o.milliseconds, c.M = o.months), s = new ep(c), ef(t) && a(t, "_locale") && (s._locale = t._locale), s
        }
        ...
        function eD(t, e) {
            return function(i, s) {
                var n;
                return null === s || isNaN(+s) || (S(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), n = i, i = s, s = n), eS(this, ek(i = "string" == typeof i ? +i : i, s), t), this
            }
        }
        ...
        function eS(e, i, s, n) {
            var o = i._milliseconds,
                r = em(i._days),
                a = em(i._months);
            e.isValid() && (n = null == n || n, a && t_(e, ty(e, "Month") + a * s), r && t$(e, "Date", ty(e, "Date") + r * s), o && e._d.setTime(e._d.valueOf() + o * s), n && t.updateOffset(e, r || a))
        }
        ek.fn = ep.prototype, ek.invalid = function() {
            return ek(NaN)
        };
        var eT = eD(1, "add"),
            e9 = eD(-1, "subtract");
        ...
        function eE(t) {
            var e;
            return void 0 === t ? this._locale._abbr : (null != (e = tG(t)) && (this._locale = e), this)
        }
        t.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ", t.defaultFormatUtc = "YYYY-MM-DDTHH:mm:ss[Z]";
        var eP = x("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function(t) {
        ...
        function e0(t, e, i, s, n) {
            var o;
            return null == t ? tP(this, s, n).year : ((o = tA(t, s, n)) < e && (e = o), (function(t, e, i, s, n) {
                var o = tE(t, e, i, s, n),
        ...
        }), eL("gggg", "weekYear"), eL("ggggg", "weekYear"), eL("GGGG", "isoWeekYear"), eL("GGGGG", "isoWeekYear"), A("weekYear", "gg"), A("isoWeekYear", "GG"), I.weekYear = 1, I.isoWeekYear = 1, tl("G", ts), tl("g", ts), tl("GG", K, V), tl("gg", K, V), tl("GGGG", tt, G), tl("gggg", tt, G), tl("GGGGG", te, Z), tl("ggggg", te, Z), tp(["gggg", "ggggg", "GGGG", "GGGGG"], function(t, e, i, s) {
            e[s.substr(0, 2)] = $(t)
        }), tp(["gg", "GG"], function(e, i, s, n) {
            i[n] = t.parseTwoDigitYear(e)
        }), R("Q", 0, "Qo", "quarter"), A("quarter", "Q"), I.quarter = 7, tl("Q", U), tu("Q", function(t, e) {
            e[1] = 3 * ($(t) - 1)
        }), R("D", ["DD", 2], "Do", "date"), A("date", "D"), I.date = 9, tl("D", K), tl("DD", K, V), tl("Do", function(t, e) {
            return t ? e._dayOfMonthOrdinalParse || e._ordinalParse : e._dayOfMonthOrdinalParseLenient
        }), tu(["D", "DD"], 2), tu("Do", function(t, e) {
            e[2] = $(t.match(K)[0])
        });
        var eH = tv("Date", !0);
        R("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), A("dayOfYear", "DDD"), I.dayOfYear = 4, tl("DDD", J), tl("DDDD", q), tu(["DDD", "DDDD"], function(t, e, i) {
            i._dayOfYear = $(t)
        }), R("m", ["mm", 2], 0, "minute"), A("minute", "m"), I.minute = 14, tl("m", K), tl("mm", K, V), tu(["m", "mm"], 4);
        var eW = tv("Minutes", !1);
        R("s", ["ss", 2], 0, "second"), A("second", "s"), I.second = 15, tl("s", K), tl("ss", K, V), tu(["s", "ss"], 5);
        var eF, ez = tv("Seconds", !1);
        for (R("S", 0, 0, function() {
            ...
            }), A("millisecond", "ms"), I.millisecond = 16, tl("S", J, U), tl("SS", J, V), tl("SSS", J, q), eF = "SSSS"; eF.length <= 9; eF += "S") tl(eF, ti);
        ...
        ej.add = eT, ej.calendar = function(e, i) {
            var s = e || el(),
            ...
            return this.isValid() && (v(t) && t.isValid() || el(t).isValid()) ? ek({
                to: this,
                from: t
            ...
            var n = v(t) ? t : el(t),
                o = v(e) ? e : el(e);
            return !!(this.isValid() && n.isValid() && o.isValid()) && ("(" === (s = s || "()")[0] ? this.isAfter(n, i) : !this.isBefore(n, i)) && (")" === s[1] ? this.isBefore(o, i) : !this.isAfter(o, i))
        }, ej.isSame = function(t, e) {
            var i, s = v(t) ? t : el(t);
            return !(!this.isValid() || !s.isValid()) && ("millisecond" === (e = O(e) || "millisecond") ? this.valueOf() === s.valueOf() : (i = s.valueOf(), this.clone().startOf(e).valueOf() <= i && i <= this.clone().endOf(e).valueOf()))
            ...
            return d(this)
        }, ej.lang = eP, ej.locale = eE, ej.localeData = eA, ej.max = ec, ej.min = eh, ej.parsingFlags = function() {
            return l({}, c(this))
        }, ej.set = function(t, e) {
            if ("object" == typeof t)
                for (var i = function(t) {
                    ...
                    }(t = Y(t)), s = 0; s < i.length; s++) this[i[s].unit](t[i[s].unit]);
            ...
            return this._d.setTime(i), t.updateOffset(this, !0), this
        }, ej.subtract = e9, ej.toArray = function() {
            ...
            return 0 > i.year() || 9999 < i.year() ? j(i, e ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : T(Date.prototype.toISOString) ? e ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", j(i, "Z")) : j(i, e ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
        }, ej.inspect = function() {
        ...
        }, ej.year = t8, ej.isLeapYear = function() {
            return tm(this.year())
        }, ej.weekYear = function(t) {
            return e0.call(this, t, this.week(), this.weekday(), this.localeData()._week.dow, this.localeData()._week.doy)
        }, ej.isoWeekYear = function(t) {
            return e0.call(this, t, this.isoWeek(), this.isoWeekday(), 1, 4)
        }, ej.quarter = ej.quarters = function(t) {
            return null == t ? Math.ceil((this.month() + 1) / 3) : this.month(3 * (t - 1) + this.month() % 3)
        }, ej.month = tC, ej.daysInMonth = function() {
            return tb(this.year(), this.month())
        }, ej.week = ej.weeks = function(t) {
            var e = this.localeData().week(this);
            return null == t ? e : this.add(7 * (t - e), "d")
        }, ej.isoWeek = ej.isoWeeks = function(t) {
        ...
        }, ej.date = eH, ej.day = ej.days = function(t) {
            ...
            return null == t ? e : this.add(t - e, "d")
        }, ej.hour = ej.hours = tB, ej.minute = ej.minutes = eW, ej.second = ej.seconds = ez, ej.millisecond = ej.milliseconds = eR, ej.utcOffset = function(e, i, s) {
            ...
            return !this._isUTC && i && (n = e$(this)), this._offset = e, this._isUTC = !0, null != n && this.add(n, "m"), o !== e && (!i || this._changeInProgress ? eS(this, ek(e - o, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, t.updateOffset(this, !0), this._changeInProgress = null)), this
        }, ej.utc = function(t) {
            ...
            return !!this.isValid() && (t = t ? el(t).utcOffset() : 0, (this.utcOffset() - t) % 60 == 0)
        }, ej.isDST = function() {
            ...
            return !!this.isValid() && this._isUTC
        }, ej.isUtc = eb, ej.isUTC = eb, ej.zoneAbbr = function() {
            return this._isUTC ? "UTC" : ""
        }, ej.zoneName = function() {
            return this._isUTC ? "Coordinated Universal Time" : ""
        }, ej.dates = x("dates accessor is deprecated. Use date instead.", eH), ej.months = x("months accessor is deprecated. Use month instead", tC), ej.years = x("years accessor is deprecated. Use year instead", t8), ej.zone = x("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(t, e) {
            return null != t ? ("string" != typeof t && (t = -t), this.utcOffset(t, e), this) : -this.utcOffset()
        }), ej.isDSTShifted = x("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function() {
        ...
        function eV(t, e, i) {
            if (n(t) && (e = t, t = void 0), t = t || "", null != e) return eU(t, e, i, "month");
            var s, o = [];
        ...
        function e2(t, e, i, s) {
            e = ("boolean" == typeof t ? n(e) && (i = e, e = void 0) : (e = t, t = !1, n(i = e) && (i = e, e = void 0)), e || "");
            var o, r = tG(),
                a = t ? r._week.dow : 0;
        ...
        e1.calendar = function(t, e, i) {
        ...
        }, e1.preparse = eB, e1.postformat = eB, e1.relativeTime = function(t, e, i, s) {
            ...
            if (this._monthsParseExact) return (function(t, e, i) {
                ...
                if (!this._monthsParse)
                    for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], s = 0; s < 12; ++s) o = h([2e3, s]), this._shortMonthsParse[s] = this.monthsShort(o, "").toLocaleLowerCase(), this._longMonthsParse[s] = this.months(o, "").toLocaleLowerCase();
                return i ? "MMM" === e ? -1 !== (n = tg.call(this._shortMonthsParse, r)) ? n : null : -1 !== (n = tg.call(this._longMonthsParse, r)) ? n : null : "MMM" === e ? -1 !== (n = tg.call(this._shortMonthsParse, r)) ? n : -1 !== (n = tg.call(this._longMonthsParse, r)) ? n : null : -1 !== (n = tg.call(this._longMonthsParse, r)) ? n : -1 !== (n = tg.call(this._shortMonthsParse, r)) ? n : null
            }).call(this, t, e, i);
            for (this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []), s = 0; s < 12; s++)
                if (n = h([2e3, s]), i && !this._longMonthsParse[s] && (this._longMonthsParse[s] = RegExp("^" + this.months(n, "").replace(".", "") + "$", "i"), this._shortMonthsParse[s] = RegExp("^" + this.monthsShort(n, "").replace(".", "") + "$", "i")), i || this._monthsParse[s] || (o = "^" + this.months(n, "") + "|^" + this.monthsShort(n, ""), this._monthsParse[s] = RegExp(o.replace(".", ""), "i")), i && "MMMM" === e && this._longMonthsParse[s].test(t) || i && "MMM" === e && this._shortMonthsParse[s].test(t) || !i && this._monthsParse[s].test(t)) return s
        }, e1.monthsRegex = function(t) {
            return this._monthsParseExact ? (a(this, "_monthsRegex") || tT.call(this), t ? this._monthsStrictRegex : this._monthsRegex) : (a(this, "_monthsRegex") || (this._monthsRegex = tS), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex)
        }, e1.monthsShortRegex = function(t) {
            return this._monthsParseExact ? (a(this, "_monthsRegex") || tT.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (a(this, "_monthsShortRegex") || (this._monthsShortRegex = tD), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex)
        }, e1.week = function(t) {
            ...
            if (this._weekdaysParseExact) return (function(t, e, i) {
                ...
                if (!this._weekdaysParse)
                    for (this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], s = 0; s < 7; ++s) o = h([2e3, 1]).day(s), this._minWeekdaysParse[s] = this.weekdaysMin(o, "").toLocaleLowerCase(), this._shortWeekdaysParse[s] = this.weekdaysShort(o, "").toLocaleLowerCase(), this._weekdaysParse[s] = this.weekdays(o, "").toLocaleLowerCase();
                return i ? "dddd" === e ? -1 !== (n = tg.call(this._weekdaysParse, r)) ? n : null : "ddd" === e ? -1 !== (n = tg.call(this._shortWeekdaysParse, r)) ? n : null : -1 !== (n = tg.call(this._minWeekdaysParse, r)) ? n : null : "dddd" === e ? -1 !== (n = tg.call(this._weekdaysParse, r)) ? n : -1 !== (n = tg.call(this._shortWeekdaysParse, r)) ? n : -1 !== (n = tg.call(this._minWeekdaysParse, r)) ? n : null : "ddd" === e ? -1 !== (n = tg.call(this._shortWeekdaysParse, r)) ? n : -1 !== (n = tg.call(this._weekdaysParse, r)) ? n : -1 !== (n = tg.call(this._minWeekdaysParse, r)) ? n : null : -1 !== (n = tg.call(this._minWeekdaysParse, r)) ? n : -1 !== (n = tg.call(this._weekdaysParse, r)) ? n : -1 !== (n = tg.call(this._shortWeekdaysParse, r)) ? n : null
            }).call(this, t, e, i);
            for (this._weekdaysParse || (this._weekdaysParse = [], this._minWeekdaysParse = [], this._shortWeekdaysParse = [], this._fullWeekdaysParse = []), s = 0; s < 7; s++)
                if (n = h([2e3, 1]).day(s), i && !this._fullWeekdaysParse[s] && (this._fullWeekdaysParse[s] = RegExp("^" + this.weekdays(n, "").replace(".", "\\.?") + "$", "i"), this._shortWeekdaysParse[s] = RegExp("^" + this.weekdaysShort(n, "").replace(".", "\\.?") + "$", "i"), this._minWeekdaysParse[s] = RegExp("^" + this.weekdaysMin(n, "").replace(".", "\\.?") + "$", "i")), this._weekdaysParse[s] || (o = "^" + this.weekdays(n, "") + "|^" + this.weekdaysShort(n, "") + "|^" + this.weekdaysMin(n, ""), this._weekdaysParse[s] = RegExp(o.replace(".", ""), "i")), i && "dddd" === e && this._fullWeekdaysParse[s].test(t) || i && "ddd" === e && this._shortWeekdaysParse[s].test(t) || i && "dd" === e && this._minWeekdaysParse[s].test(t) || !i && this._weekdaysParse[s].test(t)) return s
        }, e1.weekdaysRegex = function(t) {
            return this._weekdaysParseExact ? (a(this, "_weekdaysRegex") || tF.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex) : (a(this, "_weekdaysRegex") || (this._weekdaysRegex = t0), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex)
        }, e1.weekdaysShortRegex = function(t) {
            return this._weekdaysParseExact ? (a(this, "_weekdaysRegex") || tF.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (a(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = tH), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
        }, e1.weekdaysMinRegex = function(t) {
            return this._weekdaysParseExact ? (a(this, "_weekdaysRegex") || tF.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (a(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = tW), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
        }, e1.isPM = function(t) {
        ...
        }), t.lang = x("moment.lang is deprecated. Use moment.locale instead.", tq), t.langData = x("moment.langData is deprecated. Use moment.localeData instead.", tG);
        var e4 = Math.abs;
        ...
        function i8() {
            ...
            var t, e, i = im(this._milliseconds) / 1e3,
                s = im(this._days),
                n = im(this._months);
            ...
            return (d < 0 ? "-" : "") + "P" + (o ? u + o + "Y" : "") + (r ? u + r + "M" : "") + (a ? p + a + "D" : "") + (l || h || c ? "T" : "") + (l ? f + l + "H" : "") + (h ? f + h + "M" : "") + (c ? f + c + "S" : "")
        }
        var iv = ep.prototype;
        return iv.isValid = function() {
            return this._isValid
        }, iv.abs = function() {
            var t = this._data;
            return this._milliseconds = e4(this._milliseconds), this._days = e4(this._days), this._months = e4(this._months), t.milliseconds = e4(t.milliseconds), t.seconds = e4(t.seconds), t.minutes = e4(t.minutes), t.hours = e4(t.hours), t.months = e4(t.months), t.years = e4(t.years), this
        }, iv.add = function(t, e) {
            ...
            if ("month" === (t = O(t)) || "quarter" === t || "year" === t) switch (e = this._days + s / 864e5, i = this._months + eG(e), t) {
                case "month":
                    return i;
                case "quarter":
                    return i / 3;
                case "year":
                    return i / 12
            } else switch (e = this._days + Math.round(e7(this._months)), t) {
                case "week":
                    return e / 7 + s / 6048e5;
                case "day":
                    return e + s / 864e5;
        ...
        }, iv.asMilliseconds = eZ, iv.asSeconds = eK, iv.asMinutes = eX, iv.asHours = e6, iv.asDays = eQ, iv.asWeeks = eJ, iv.asMonths = it, iv.asQuarters = ie, iv.asYears = ii, iv.valueOf = function() {
            ...
            var t, e, i, s, n, o = this._milliseconds,
                ...
                a = this._months,
                l = this._data;
            return 0 <= o && 0 <= r && 0 <= a || o <= 0 && r <= 0 && a <= 0 || (o += 864e5 * e3(e7(a) + r), a = r = 0), l.milliseconds = o % 1e3, t = y(o / 1e3), l.seconds = t % 60, e = y(t / 60), l.minutes = e % 60, i = y(e / 60), l.hours = i % 24, a += n = y(eG(r += y(i / 24))), r -= e3(e7(n)), s = y(a / 12), a %= 12, l.days = r, l.months = a, l.years = s, this
        }, iv.clone = function() {
            return ek(this)
        }, iv.get = function(t) {
            return t = O(t), this.isValid() ? this[t + "s"]() : NaN
        }, iv.milliseconds = io, iv.seconds = ir, iv.minutes = ia, iv.hours = il, iv.days = ih, iv.weeks = function() {
            return y(this.days() / 7)
        }, iv.months = ic, iv.years = id, iv.humanize = function(t) {
            if (!this.isValid()) return this.localeData().invalidDate();
            var e, i, s, n, o, r, a, l, h, c, d, u = this.localeData(),
                p = (i = !t, s = u, n = ek(e = this).abs(), o = iu(n.as("s")), r = iu(n.as("m")), a = iu(n.as("h")), l = iu(n.as("d")), h = iu(n.as("M")), c = iu(n.as("y")), (d = o <= ip.ss && ["s", o] || o < ip.s && ["ss", o] || r <= 1 && ["m"] || r < ip.m && ["mm", r] || a <= 1 && ["h"] || a < ip.h && ["hh", a] || l <= 1 && ["d"] || l < ip.d && ["dd", l] || h <= 1 && ["M"] || h < ip.M && ["MM", h] || c <= 1 && ["y"] || ["yy", c])[2] = i, d[3] = 0 < +e, d[4] = s, (function(t, e, i, s, n) {
                    return n.relativeTime(e || 1, !!i, t, s)
                }).apply(null, d));
            return t && (p = u.pastFuture(+this, p)), u.postformat(p)
        }, iv.toISOString = i8, iv.toString = i8, iv.toJSON = i8, iv.locale = eE, iv.localeData = eA, iv.toIsoString = x("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", i8), iv.lang = eP, R("X", 0, 0, "unix"), R("x", 0, 0, "valueOf"), tl("x", ts), tl("X", /[+-]?\d+(\.\d{1,3})?/), tu("X", function(t, e, i) {
            i._d = new Date(1e3 * parseFloat(t, 10))
        }), tu("x", function(t, e, i) {
            i._d = new Date($(t))
        }), t.version = "2.24.0", k = el, t.fn = ej, t.min = function() {
        ...
        }, t.isDate = o, t.locale = tq, t.invalid = u, t.duration = ek, t.isMoment = v, t.weekdays = function(t, e, i) {
            return e2(t, e, i, "weekdays")
        }, t.parseZone = function() {
            return el.apply(null, arguments).parseZone()
        }, t.localeData = tG, t.isDuration = ef, t.monthsShort = function(t, e) {
            return eV(t, e, "monthsShort")
        }, t.weekdaysMin = function(t, e, i) {
            return e2(t, e, i, "weekdaysMin")
        }, t.defineLocale = t3, t.updateLocale = function(t, e) {
            if (null != e) {
                var i, s, n = t1;
                null != (s = t4(t)) && (n = s._config), (i = new E(e = M(n, e))).parentLocale = tU[t], tU[t] = i, tq(t)
            } else null != tU[t] && (null != tU[t].parentLocale ? tU[t] = tU[t].parentLocale : null != tU[t] && delete tU[t]);
            return tU[t]
        }, t.locales = function() {
            return C(tU)
            ...
            return void 0 !== ip[t] && (void 0 === e ? ip[t] : (ip[t] = e, "s" === t && (ip.ss = e - 1), !0))
        }, t.calendarFormat = function(t, e) {
            var i = t.diff(e, "days", !0);
            return i < -6 ? "sameElse" : i < -1 ? "lastWeek" : i < 0 ? "lastDay" : i < 1 ? "sameDay" : i < 2 ? "nextDay" : i < 7 ? "nextWeek" : "sameElse"
        }, t.prototype = ej, t.HTML5_FMT = {
    ...
    function(t, e) {
        ...
        var i = function(i, s, n) {
            if (this.parentEl = "body", this.element = e(i), this.startDate = t().startOf("day"), this.endDate = t().endOf("day"), this.minDate = !1, this.maxDate = !1, this.maxSpan = !1, this.autoApply = !1, this.singleDatePicker = !1, this.showDropdowns = !1, this.minYear = t().subtract(100, "year").format("YYYY"), this.maxYear = t().add(100, "year").format("YYYY"), this.showWeekNumbers = !1, this.showISOWeekNumbers = !1, this.showCustomRangeLabel = !0, this.timePicker = !1, this.timePicker24Hour = !1, this.timePickerIncrement = 1, this.timePickerSeconds = !1, this.linkedCalendars = !0, this.autoUpdateInput = !0, this.alwaysShowCalendars = !1, this.ranges = {}, this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = "btn btn-sm", this.applyButtonClasses = "btn-primary", this.cancelButtonClasses = "btn-default", this.locale = {
                ...
                var o, r, a, l = document.createElement("textarea");
            ...
            if (void 0 === s.startDate && void 0 === s.endDate && e(this.element).is(":text")) {
                ...
                o = r = null, 2 == u.length ? (o = t(u[0], this.locale.format), r = t(u[1], this.locale.format)) : this.singleDatePicker && "" !== d && (o = t(d, this.locale.format), r = t(d, this.locale.format)), null !== o && null !== r && (this.setStartDate(o), this.setEndDate(r))
            }
            if ("object" == typeof s.ranges) {
                for (a in s.ranges) {
                    o = "string" == typeof s.ranges[a][0] ? t(s.ranges[a][0], this.locale.format) : t(s.ranges[a][0]), r = "string" == typeof s.ranges[a][1] ? t(s.ranges[a][1], this.locale.format) : t(s.ranges[a][1]), this.minDate && o.isBefore(this.minDate) && (o = this.minDate.clone());
                    var p = this.maxDate;
                    if (this.maxSpan && p && o.clone().add(this.maxSpan).isAfter(p) && (p = o.clone().add(this.maxSpan)), p && r.isAfter(p) && (r = p.clone()), !(this.minDate && r.isBefore(this.minDate, this.timepicker ? "minute" : "day") || p && o.isAfter(p, this.timepicker ? "minute" : "day"))) {
                ...
                var f = "<ul>";
                for (a in this.ranges) f += '<li data-range-key="' + a + '">' + a + "</li>";
        ...
        return i.prototype = {
            ...
            updateCalendars: function() {
                if (this.timePicker) {
                    var t, e, i;
                    if (this.endDate) {
                        if (t = parseInt(this.container.find(".left .hourselect").val(), 10), isNaN(e = parseInt(this.container.find(".left .minuteselect").val(), 10)) && (e = parseInt(this.container.find(".left .minuteselect option:last").val(), 10)), i = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0, !this.timePicker24Hour) {
                            var s = this.container.find(".left .ampmselect").val();
                            "PM" === s && t < 12 && (t += 12), "AM" === s && 12 === t && (t = 0)
                        }
                    } else if (t = parseInt(this.container.find(".right .hourselect").val(), 10), isNaN(e = parseInt(this.container.find(".right .minuteselect").val(), 10)) && (e = parseInt(this.container.find(".right .minuteselect option:last").val(), 10)), i = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0, !this.timePicker24Hour) {
            ...
            renderCalendar: function(i) {
                var s, n, o = "left" == i ? this.leftCalendar : this.rightCalendar,
                    r = o.month.month(),
                    a = o.month.year(),
                    l = o.month.hour(),
                    h = o.month.minute(),
                ...
                k += "<thead>", k += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (k += "<th></th>"), (!w || w.isBefore(o.firstDay)) && (!this.linkedCalendars || "left" == i) ? k += '<th class="prev available"><span></span></th>' : k += "<th></th>";
                var _ = this.locale.monthNames[o[1][1].month()] + o[1][1].format(" YYYY");
                if (this.showDropdowns) {
                    for (var C = o[1][1].month(), D = o[1][1].year(), S = x && x.year() || this.maxYear, T = w && w.year() || this.minYear, M = D == T, E = D == S, P = '<select class="monthselect">', A = 0; A < 12; A++)(!M || w && A >= w.month()) && (!E || x && A <= x.month()) ? P += "<option value='" + A + "'" + (A === C ? " selected='selected'" : "") + ">" + this.locale.monthNames[A] + "</option>" : P += "<option value='" + A + "'" + (A === C ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[A] + "</option>";
                    P += "</select>";
                    for (var O = '<select class="yearselect">', Y = T; Y <= S; Y++) O += '<option value="' + Y + '"' + (Y === D ? ' selected="selected"' : "") + ">" + Y + "</option>";
                    O += "</select>", _ = P + O
                }
                if (k += '<th colspan="5" class="month">' + _ + "</th>", (!x || x.isAfter(o.lastDay)) && (!this.linkedCalendars || "right" == i || this.singleDatePicker) ? k += '<th class="next available"><span></span></th>' : k += "<th></th>", k += "</tr>", k += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (k += '<th class="week">' + this.locale.weekLabel + "</th>"), e.each(this.locale.daysOfWeek, function(t, e) {
                        k += "<th>" + e + "</th>"
                ...
                for (var n = 0; n < 6; n++) {
                    k += "<tr>", this.showWeekNumbers ? k += '<td class="week">' + o[n][0].week() + "</td>" : this.showISOWeekNumbers && (k += '<td class="week">' + o[n][0].isoWeek() + "</td>");
                    for (var s = 0; s < 7; s++) {
                        var L = [];
                        o[n][s].isSame(new Date, "day") && L.push("today"), o[n][s].isoWeekday() > 5 && L.push("weekend"), o[n][s].month() != o[1][1].month() && L.push("off", "ends"), this.minDate && o[n][s].isBefore(this.minDate, "day") && L.push("off", "disabled"), x && o[n][s].isAfter(x, "day") && L.push("off", "disabled"), this.isInvalidDate(o[n][s]) && L.push("off", "disabled"), o[n][s].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && L.push("active", "start-date"), null != this.endDate && o[n][s].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && L.push("active", "end-date"), null != this.endDate && o[n][s] > this.startDate && o[n][s] < this.endDate && L.push("in-range");
                        var H = this.isCustomDate(o[n][s]);
                        !1 !== H && ("string" == typeof H ? L.push(H) : Array.prototype.push.apply(L, H));
                        for (var W = "", F = !1, y = 0; y < L.length; y++) W += L[y] + " ", "disabled" == L[y] && (F = !0);
                        F || (W += "available"), k += '<td class="' + W.replace(/^\s+|\s+$/g, "") + '" data-title="r' + n + "c" + s + '">' + o[n][s].date() + "</td>"
                    }
                    k += "</tr>"
                }
            ...
            renderTimePicker: function(t) {
                if ("right" != t || this.endDate) {
                    ...
                    if (this.maxSpan && (!this.maxDate || this.startDate.clone().add(this.maxSpan).isBefore(this.maxDate)) && (n = this.startDate.clone().add(this.maxSpan)), "left" == t) i = this.startDate.clone(), s = this.minDate;
                    else if ("right" == t) {
                        i = this.endDate.clone(), s = this.startDate;
                        var o = this.container.find(".drp-calendar.right .calendar-time");
                        if ("" != o.html() && (i.hour(isNaN(i.hour()) ? o.find(".hourselect option:selected").val() : i.hour()), i.minute(isNaN(i.minute()) ? o.find(".minuteselect option:selected").val() : i.minute()), i.second(isNaN(i.second()) ? o.find(".secondselect option:selected").val() : i.second()), !this.timePicker24Hour)) {
                            var r = o.find(".ampmselect option:selected").val();
                            "PM" === r && 12 > i.hour() && i.hour(i.hour() + 12), "AM" === r && 12 === i.hour() && i.hour(0)
                        }
                        i.isBefore(this.startDate) && (i = this.startDate.clone()), n && i.isAfter(n) && (i = n.clone())
                    }
                    e = '<select class="hourselect">';
                    for (var a = this.timePicker24Hour ? 0 : 1, l = this.timePicker24Hour ? 23 : 12, h = a; h <= l; h++) {
                        var c = h;
                        this.timePicker24Hour || (c = i.hour() >= 12 ? 12 == h ? 12 : h + 12 : 12 == h ? 0 : h);
                        var d = i.clone().hour(c),
                            u = !1;
                        s && d.minute(59).isBefore(s) && (u = !0), n && d.minute(0).isAfter(n) && (u = !0), c != i.hour() || u ? u ? e += '<option value="' + h + '" disabled="disabled" class="disabled">' + h + "</option>" : e += '<option value="' + h + '">' + h + "</option>" : e += '<option value="' + h + '" selected="selected">' + h + "</option>"
                    }
                    ...
                    for (var h = 0; h < 60; h += this.timePickerIncrement) {
                        var p = h < 10 ? "0" + h : h,
                            d = i.clone().minute(h),
                            u = !1;
                        s && d.second(59).isBefore(s) && (u = !0), n && d.second(0).isAfter(n) && (u = !0), i.minute() != h || u ? u ? e += '<option value="' + h + '" disabled="disabled" class="disabled">' + p + "</option>" : e += '<option value="' + h + '">' + p + "</option>" : e += '<option value="' + h + '" selected="selected">' + p + "</option>"
                    }
                    if (e += "</select> ", this.timePickerSeconds) {
                        ...
                        for (var h = 0; h < 60; h++) {
                            var p = h < 10 ? "0" + h : h,
                                d = i.clone().second(h),
                                u = !1;
                            s && d.isBefore(s) && (u = !0), n && d.isAfter(n) && (u = !0), i.second() != h || u ? u ? e += '<option value="' + h + '" disabled="disabled" class="disabled">' + p + "</option>" : e += '<option value="' + h + '">' + p + "</option>" : e += '<option value="' + h + '" selected="selected">' + p + "</option>"
                        }
                        e += "</select> "
                    }
                    if (!this.timePicker24Hour) {
                        ...
                        var f = "",
                            m = "";
                        s && i.clone().hour(12).minute(0).second(0).isBefore(s) && (f = ' disabled="disabled" class="disabled"'), n && i.clone().hour(0).minute(0).second(0).isAfter(n) && (m = ' disabled="disabled" class="disabled"'), i.hour() >= 12 ? e += '<option value="AM"' + f + '>AM</option><option value="PM" selected="selected"' + m + ">PM</option>" : e += '<option value="AM" selected="selected"' + f + '>AM</option><option value="PM"' + m + ">PM</option>", e += "</select>"
                    }
            ...
            move: function() {
                ...
                }, n = this.parentEl[0].clientWidth + this.parentEl.offset().left), s) {
                    case "auto":
                        (t = this.element.offset().top + this.element.outerHeight() - i.top) + this.container.outerHeight() >= this.parentEl[0].scrollHeight && (t = this.element.offset().top - this.container.outerHeight() - i.top, s = "up");
                        break;
                    case "up":
                ...
                if (this.container.toggleClass("drop-up", "up" == s), "left" == this.opens) {
                    ...
                    o + r > e(window).width() ? this.container.css({
                        top: t,
                        right: "auto",
                        left: 9
                    }) : this.container.css({
                    ...
                    var a = this.element.offset().left - i.left + this.element.outerWidth() / 2 - o / 2;
                    ...
                    this.endDate || this.container.find(".drp-calendar tbody td").each(function(t, i) {
                        if (!e(i).hasClass("week")) {
                            var s = e(i).attr("data-title"),
                                n = s.substr(1, 1),
                                h = s.substr(3, 1),
                                c = e(i).parents(".drp-calendar").hasClass("left") ? r.calendar[n][h] : a.calendar[n][h];
                            c.isAfter(l) && c.isBefore(o) || c.isSame(o, "day") ? e(i).addClass("in-range") : e(i).removeClass("in-range")
                        }
                    })
                }
            },
                ...
                if (e(t.target).hasClass("available")) {
                    ...
                    if (this.endDate || o.isBefore(this.startDate, "day")) {
                        ...
                        if (this.timePicker) {
                            ...
                            var h = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0;
                            o = o.clone().hour(r).minute(l).second(h)
                        }
        ...
        n.prototype = {
            ...
            mousewheel: function(e) {
                if (!this.disableMousewheel) {
                    ...
                    var i = e.originalEvent.wheelDelta || -e.originalEvent.detail,
                        s = null;
                    switch ("mousewheel" === e.type ? s = -1 * e.originalEvent.wheelDelta : "DOMMouseScroll" === e.type && (s = 40 * e.originalEvent.detail), s && (e.preventDefault(), t(this).scrollTop(s + t(this).scrollTop())), this.highlightedUnit) {
                        case "minute":
            ...
            place: function() {
                if (!this.isInline) {
                    ...
                    "auto" === m && (m = Math.max(p = -r + l.top - s, f = r + o - (l.top + h + s)) === f ? "top" : "bottom"), this.$widget.addClass("timepicker-orient-" + m), "top" === m ? "body" != this.appendWidgetTo ? (u = "100%", d = "0") : u += h : "body" != this.appendWidgetTo ? (u = -s, d = "0") : u -= s + parseInt(this.$widget.css("padding-top"), 10), this.$widget.css({
                        top: u,
                        left: d,
                        zIndex: a
                    })
            ...
            setDefaultTime: function(t) {
                if (this.$element.val()) this.updateFromElementVal();
                    ...
                    var e = new Date,
                        ...
                        n = e.getSeconds(),
                        o = "AM";
                    0 !== n && 60 == (n = Math.ceil(e.getSeconds() / this.secondStep) * this.secondStep) && (s += 1, n = 0), 0 !== s && 60 == (s = Math.ceil(e.getMinutes() / this.minuteStep) * this.minuteStep) && (i += 1, s = 0), this.showMeridian && (0 === i ? i = 12 : i >= 12 ? (i > 12 && (i -= 12), o = "PM") : o = "AM"), this.hour = i, this.minute = s, this.second = n, this.meridian = o, this.update()
            ...
            widgetClick: function(e) {
                ...
                s && this[s](), this.update(), i.is("input") && i.get(0).setSelectionRange(0, 2)
            },
            ...
            return i.shift(), this.each(function() {
                var s = t(this),
                    o = s.data("timepicker");
                o || s.data("timepicker", o = new n(this, t.extend({}, t.fn.timepicker.defaults, "object" == typeof e && e, t(this).data()))), "string" == typeof e && o[e].apply(o, i)
            })
